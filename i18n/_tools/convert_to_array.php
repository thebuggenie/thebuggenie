...
$phpFile->fwrite("// Please, do not edit this file !". __NEWLINE__);
$phpFile->fwrite("// If you would like to help translating TBG,". __NEWLINE__);
$phpFile->fwrite("// please visit https://www.transifex.com/projects/p/tbg");
$phpFile->fwrite(__NEWLINE__ . __NEWLINE__);

$phpFile->fwrite("// Number of Sections: " . (count($translations) - 1) . __NEWLINE__);
$phpFile->fwrite("// Number of Strings: " . $nbstrings . __NEWLINE__);
$phpFile->fwrite("// Strings extracted on: " . date('Y M d.') . __NEWLINE__);
