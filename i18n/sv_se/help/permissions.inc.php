...
When defining permissions, you have a colored "buttons" that tell you what permission is granted for that specific item:
<div style="padding: 10px; margin-left: 15px;">
	<p><img src="themes/default/led_green.png"> - Full access to that specific item. For items with read/write access, green means you have read and write access.</p>
	<p><img src="themes/default/led_yellow.png"> - Limited access to that specific item - only for items with read/write access - means you have only read access.</p>
	<p><img src="themes/default/led_red.png"> - No access to that specific item.</p>
	<p><img src="themes/default/led_lightblue.png"> - Permission not explicitly granted for this user/team/group. When you have a blue icon, access is defined on a lower level.</p>
</div>
...
Now, users in the admin group have access to all sections in the Configuration center, except "Manage users" and "Scopes", which is only L�gg till �rende to users in the "Staff members" team.<br>
<br>
