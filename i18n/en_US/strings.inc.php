<?php
	...
	$strings['To auto-link to an existing issue, write "issue", "bug", "ticket" or the issue type (like "bug report" or "enhancement") followed by the issue number (ex: "%ticket_example_1%" or "%ticket_example_2%"). Enclose sourcecode samples in <source></source> tags.'] = 'To auto-link to an existing issue, write "issue", "bug", "ticket" or the issue type (like "bug report" or "enhancement") followed by the issue number (ex: "%ticket_example_1%" or "%ticket_example_2%"). Enclose sourcecode samples in <source></source> tags. Link to a general wiki page (which will create a new page when clicked if it does not yet exist) by typing out TwoOrMoreCapitalizedWordsStuckTogether =  CamelCase OR [[double bracket a single word]]. Link to project wiki page by [[ + Project Name + : + WikiPageName + ]] = [[Project Name:Name]].  NOTE: use double brackets ONLY for single word names, as you will get_words_with_lines_between_them. CamelCase words will get a space between the words when their wiki pages are created.';
