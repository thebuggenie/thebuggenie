...
<table style="width: 100%;" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td style="width: auto; padding: 5px; vertical-align: top;" id="find_issues">
			<div class="rounded_box lightgreen_borderless" style="margin: 5px 0 5px 0;">
				<b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
				<div class="xboxcontent" style="padding: 3px 10px 3px 10px; font-size: 14px;">
					<form accept-charset="<?php echo BUGScontext::getI18n()->getCharset(); ?>" action="<?php echo (BUGScontext::isProjectContext()) ? make_url('project_issues', array('project_key' => BUGScontext::getCurrentProject()->getKey())) : make_url('search'); ?>" method="post">
						...
						<select name="issues_per_page">
							<?php foreach (array(1, 15, 30, 50, 100) as $cc): ?>
			...
			<?php if ($show_results): ?>
				<div class="main_header">
					...
					&nbsp;&nbsp;<span class="faded_medium"><?php echo __('%number_of% issues', array('%number_of%' => $resultcount)); ?></span>
				</div>
