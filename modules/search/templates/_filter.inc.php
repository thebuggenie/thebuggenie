	...
	<?php if (in_array($filter, TBGIssuesTable::getValidSearchFilters())): ?>
		<?php if ($filter == 'project_id' && !TBGContext::isProjectContext()): ?>
			...
			<?php else: ?>
				...
				<a class="image" href="javascript:void(0);" onclick="TBG.Search.removeFilter(<?php echo $key; ?>);"><?php echo image_tag('action_remove_small.png', array('style' => 'margin-left: 5px;')); ?></a>
			<?php endif; ?>
