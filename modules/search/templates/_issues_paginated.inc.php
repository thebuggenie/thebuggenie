<?php include_template("search/{$templatename}", array('issues' => $issues, 'template_parameter' => $template_parameter, 'groupby' => $groupby, 'cc' => 1, 'prevgroup_id' => null, 'show_project' => true)); ?>
