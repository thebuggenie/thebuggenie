			...
			<?php else: ?>
				...
				<?php foreach ($eventstoday as $anevent): ?>
					<tr>
						...
						<td>
							<a href="javascript:void(0);" onclick="window.open('<?php echo BUGScontext::getTBGPath(); ?>modules/calendar/show_event.php?id=<?php echo $anevent->getID(); ?>','showevent','menubar=0,toolbar=0,location=0,status=0,scrollbars=0,width=600,height=400');"><?php echo $anevent->getTitle(); ?></a><br>
