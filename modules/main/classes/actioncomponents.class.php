<?php 
	...
	class mainActionComponents extends TBGActionComponent
	{
		...
		protected function setupVariables()
		{
			...
			if ($this->issue->isEditable()) $fields_list['category']['choices'] = TBGCategory::getAll();
			...
			if ($this->issue->isUpdateable()) $fields_list['resolution']['choices'] = TBGResolution::getAll();
			...
			if ($this->issue->isUpdateable()) $fields_list['milestone']['choices'] = $this->issue->getProject()->getAllMilestones();
