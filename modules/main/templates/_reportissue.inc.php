		...
		<div class="report_form" id="report_form"<?php if (!$selected_project instanceof TBGProject || !$selected_issuetype instanceof TBGPssuetype): ?> style="display: none;"<?php endif; ?>>
			<table cellpadding="0" cellspacing="0"<?php if (array_key_exists('title', $errors)): ?> class="reportissue_error"<?php endif; ?>>
				<tr>
					...
					<td style="text-align: right;"><input type="text" name="title" id="title" class="title" value="<?php if (isset($title) && trim($title) != '') echo htmlspecialchars($title); ?>" placeholder="<?php echo __('Enter a short, but descriptive summary of the issue here'); ?>"></td>
				</tr>
			</table>
			...
			<table cellpadding="0" cellspacing="0" id="estimated_time_div" style="display: none; margin-top: 15px;"<?php if (array_key_exists('estimated_time', $errors)): ?> class="reportissue_error"<?php endif; ?>>
				<tr>
					...
					<td style="text-align: left;"><input type="text" name="estimated_time" id="estimated_time_id" style="width: 810px;" value="<?php if ($selected_estimated_time !== null) echo $selected_estimated_time; ?>" placeholder="<?php echo __('Enter an estimate here'); ?>"></td>
				</tr>
				<tr>
			...
			<table cellpadding="0" cellspacing="0" id="spent_time_div" style="display: none; margin-top: 15px;"<?php if (array_key_exists('spent_time', $errors)): ?> class="reportissue_error"<?php endif; ?>>
				<tr>
					...
					<td style="text-align: left;"><input type="text" name="spent_time" id="spent_time_id" style="width: 810px;" value="<?php if ($selected_spent_time !== null) echo $selected_spent_time; ?>" placeholder="<?php echo __('Enter time spent here'); ?>"></td>
				</tr>
				<tr>
