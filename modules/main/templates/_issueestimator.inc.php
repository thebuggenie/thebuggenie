<div class="rounded_box white <?php if (isset($mode) && $mode == 'inline'): ?>borderless<?php else: ?><?php if (isset($mode) && $mode == 'left') echo ' leftie '; ?>shadowed dropdown_box<?php endif; ?>" id="<?php echo $field . '_' . $issue_id; ?>_change" style="<?php if (!isset($hidden) || $hidden == true): ?>display: none;<?php endif; ?> <?php if (!(isset($mode) && $mode == 'inline')): ?>width: 350px;<?php endif; ?> margin: 5px 0 5px 0; <?php if (isset($mode) && $mode == 'inline'): ?>position: relative;<?php else: ?>position: absolute; z-index: 10001;<?php endif; ?> <?php echo (isset($mode) && $mode == 'left') ? 'left' : 'right'; ?>: 0; padding: 5px; text-align: left;">
