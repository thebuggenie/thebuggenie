<div class="rounded_box borderless lightgrey menu_links" id="<?php echo $target_type; ?>_<?php echo $target_id; ?>_container" style="margin: 10px 0 5px 5px; padding: 10px;">
	<div class="header">
...
<?php if ($tbg_user->canEditMainMenu()): ?>
	<div class="rounded_box borderless lightgrey" id="attach_link_<?php echo $target_type; ?>_<?php echo $target_id; ?>" style="margin: 5px 0 5px 5px; display: none">
