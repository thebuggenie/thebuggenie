<div class="rounded_box borderless menu_links" id="<?php echo $target_type; ?>_<?php echo $target_id; ?>_container" style="margin: 10px 0 5px 5px;">
...
<?php if ($tbg_user->canEditMainMenu()): ?>
	<div class="rounded_box borderless" id="attach_link_<?php echo $target_type; ?>_<?php echo $target_id; ?>" style="margin: 5px 0 5px 5px; display: none">
		<b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
