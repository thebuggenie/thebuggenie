<div class="backdrop_box huge" id="reportissue_container">
	...
	<div id="backdrop_detail_content">
		<?php include_component('main/reportissue', compact('selected_project', 'issue', 'issuetypes', 'selected_issuetype', 'selected_milestone', 'selected_build', 'errors', 'permission_errors')); ?>
	</div>
