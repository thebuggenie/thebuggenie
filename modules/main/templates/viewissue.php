...
//		require_once(BUGScontext::getIncludePath() . 'js/viewissue_ajax.js.php');
	...
	<form action="<?php echo make_url('issue_stopworking', array('issue_id' => $theIssue->getFormattedIssueNo())); ?>" method="post">
	...
	<?php endif; ?>
	<form action="<?php echo make_url('saveissue', array('issue_no' => $theIssue->getFormattedIssueNo())); ?>" method="post">
	...
	<?php if ($theIssue->isDuplicate()): ?>
		<div class="rounded_box iceblue_borderless" id="viewissue_duplicate">
			...
			<div class="xboxcontent" style="vertical-align: middle; padding: 0;">
				...
				<div class="viewissue_info_header"><?php echo __('This issue is a duplicate of Issue %link_to_duplicate_issue%', array('%link_to_duplicate_issue%' => link_tag(make_url('viewissue', array('issue_no' => $theIssue->getDuplicateOf()->getFormattedIssueNo())), $theIssue->getDuplicateOf()->getFormattedIssueNo(true)) . ' - "' . $theIssue->getDuplicateOf()->getTitle() . '"')); ?></div>
	...
	<?php if ($theIssue->isClosed() && $theIssue->getPostedBy()->getID() == $bugs_user->getID() && !BUGSuser::isThisGuest()): ?>
		<div class="rounded_box iceblue_borderless" id="viewissue_closed_sameuser">
			...
			<div class="xboxcontent" style="vertical-align: middle; padding: 0;">
				...
				<div class="viewissue_info_content"><?php echo __('If you have new information and you think this issue should be reopened, then %reopen_the_issue%', array('%reopen_the_issue%' => link_tag(make_url('openissue', array('issue_id' => $theIssue->getID())), __('reopen the issue')))); ?></div>
			</div>
			<b class="xbottom"><b class="xb4"></b><b class="xb3"></b><b class="xb2"></b><b class="xb1"></b></b>
		</div>								
	<?php elseif ($theIssue->isOpen() && $theIssue->getPostedBy()->getID() == $bugs_user->getID() && !BUGSuser::isThisGuest()): ?>
		<div class="rounded_box iceblue_borderless" id="viewissue_open_sameuser">
			...
			<div class="xboxcontent" style="vertical-align: middle; padding: 0;">
				...
				<div class="viewissue_info_content"><?php echo __('If you think this issue should be closed without further investigation, then %close_the_issue%', array('%close_the_issue%' => link_tag(make_url('closeissue', array('issue_id' => $theIssue->getID())), __('close the issue')))); ?></div>
			</div>
			<b class="xbottom"><b class="xb4"></b><b class="xb3"></b><b class="xb2"></b><b class="xb1"></b></b>
		</div>								
					...
					<table style="table-layout: fixed; width: 100%; margin: 10px 0 10px 0; background-color: transparent;" cellpadding=0 cellspacing=0>
						<tr>
							...
							<td style="font-size: 19px; width: auto; padding: 0; padding-left: 7px;">
								<b><?php echo __('Issue %issue_no%', array('%issue_no%' => link_tag(make_url('viewissue', array('issue_no' => $theIssue->getFormattedIssueNo())), $theIssue->getFormattedIssueNo(true)))); ?>&nbsp;&nbsp;-&nbsp;&nbsp;<span id="issue_title"><?php echo $theIssue->getTitle(); ?></span></b><br>
