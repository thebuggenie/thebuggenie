		...
		<tr>
			...
			<td valign="top" align="left" style="padding-right: 5px;" id="issue_main">
				...
				<div class="comments">
					...
					<?php if ($tbg_user->canPostComments()): ?><div id="comment_add_button"><a href="javascript:null();" onClick="$('comment_add_button').hide(); $('comment_add').show(); return false;"><?php echo image_tag('action_add_small.png', array('title' => __('Add new comment'))); ?> Add new comment</a></div>
