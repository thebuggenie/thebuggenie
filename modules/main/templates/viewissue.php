<?php if ($theIssue instanceof TBGIssue): ?>
	...
	<div style="width: 1000px; padding: 5px; margin: 0 auto 0 auto;">
		...
		<div class="rounded_box <?php if ($theIssue->getIssueType()->getItemdata() == 'task'): ?>yellow_borderless<?php else: ?>lightgrey<?php endif; ?>" id="viewissue_left_box_top">
			<b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
			<div class="xboxcontent" style="padding: 5px;">
				<table style="table-layout: auto; width: 100%; clear: both;" cellpadding=0 cellspacing=0 id="issue_view">
					<tr>
						...
						<td valign="top" align="left" style="padding-right: 5px;" class="issue_main">
							<?php
							...
							<div id="description_field"<?php if (!$theIssue->isDescriptionVisible()): ?> style="display: none;"<?php endif; ?>>
								<div class="rounded_box invisible<?php if ($theIssue->isDescriptionChanged()): ?> issue_detail_changed<?php endif; ?><?php if (!$theIssue->isDescriptionMerged()): ?> issue_detail_unmerged<?php endif; ?>" id="description_header" style="margin: 0 0 5px 0;">
									<b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
