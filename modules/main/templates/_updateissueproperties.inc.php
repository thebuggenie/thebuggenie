<div class="rounded_box white borderless shadowed backdrop_box mediumsmall issuedetailspopup" style="padding: 5px; text-align: left; font-size: 13px; display: none;" id="issue_transition_container_<?php echo $transition->getId(); ?>">
