...
<div class="client_dashboard">
	<div class="dashboard_client_info">
		<span class="dashboard_client_header"><?php echo $client->getName(); ?> <?php echo __('dashboard'); ?></span><br />
	...
	<?php else: ?>
		<p class="content"><?php echo __('There are no projects assigned to this client'); ?>.</p>
	<?php endif; ?>
</div>