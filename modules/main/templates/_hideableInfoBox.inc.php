<?php if ($show_box): ?>
	<div class="rounded_box iceblue borderless infobox" style="margin: 5px;" id="infobox_<?php echo $key; ?>">
		<div style="padding: 5px;">
			...
			<form id="close_me_<?php echo $key; ?>_form" action="<?php echo make_url('hide_infobox', array('key' => $key)); ?>" method="post" accept-charset="<?php echo TBGSettings::getCharset(); ?>" onsubmit="thebuggenie.events.hideInfobox('<?php echo make_url('hide_infobox', array('key' => $key)); ?>', '<?php echo $key; ?>');return false;">
				<div class="close_me">
