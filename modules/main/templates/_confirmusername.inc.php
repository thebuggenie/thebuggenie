<div class="backdrop_box large" id="username_confirmation_popup">
	...
	<div id="backdrop_detail_content">
		...
		<div style="text-align: center;">
			<form accept-charset="<?php echo TBGContext::getI18n()->getCharset(); ?>" action="<?php echo make_url('account_pick_username', array('selected_username' => $username)); ?>" method="post" id="pick_username_form">
				<?php echo csrf_tag(); ?>
