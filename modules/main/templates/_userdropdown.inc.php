...
<?php else: ?>
	...
	<a href="javascript:void(0);" onclick="$('bud_<?php echo $user->getUname() . "_" . $rnd_no; ?>').toggle();" class="image"><?php echo image_tag($user->getAvatarURL(), array('style' => "width: {$avatar_dimensions}px; height: {$avatar_dimensions}px; float: left; margin-right: 5px;"), true); ?></a>
	<a href="javascript:void(0);" onclick="$('bud_<?php echo $user->getUname() . "_" . $rnd_no; ?>').toggle();" style="font-weight: normal;"><?php echo $user->getBuddyname(); ?></a>
	<div id="bud_<?php echo $user->getUname() . '_' . $rnd_no; ?>" style="z-index: 100; width: 300px; display: none; position: absolute;" class="rounded_box white shadowed user_popup">
		<div style="padding: 3px;">
			...
			<?php if (TBGUser::isThisGuest() == false): ?>
				<div id="friends_message_<?php echo $user->getUname() . '_' . $rnd_no; ?>" style="padding: 2px 0 2px 0; font-size: 0.9em;"></div>
		...
		<div style="text-align: right; padding: 3px; font-size: 9px;"><a href="javascript:void(0);" onclick="$('bud_<?php echo $user->getUname() . "_" . $rnd_no; ?>').toggle();"><?php echo __('Close this menu'); ?></a></div>
	</div>
<?php endif; ?>