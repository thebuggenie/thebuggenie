...
<div class="textarea_container syntax_<?php echo $syntax; ?>">
	<div class="syntax_picker_container">
		...
		<a id="<?php echo $base_id; ?>_toggle_syntax_button" onclick="return false;" class="button button-silver syntax_picker dropper"><?php echo __('Syntax: %selected_syntax', array('%selected_syntax' => '<span id="'.$base_id.'_selected_syntax">'.$syntaxname.'</span>')); ?>&nbsp;&nbsp;<span style="font-size: 0.8em; float: right;">&#x25BC;</span></a>
