...
<div style="margin-top: 0px;">
	...
	else
	{
		...
		<td style="background: url('<?php print "themes/" .  TBGSettings::getThemeName(); ?>/clock.png') no-repeat right; text-align: right; padding: 3px; padding-right: 25px;"><?php print tbg_formatTime($_SERVER["REQUEST_TIME"], 3); ?></td>
		...
		<tr>
		<td style="padding: 0px; height: 70px; width: 70px; border: 1px solid #DDD; text-align: center;" align="right" valign="middle" id="avatar_td"><?php echo image_tag($tbg_user->getAvatarURL(false), array(), true); ?></td>
