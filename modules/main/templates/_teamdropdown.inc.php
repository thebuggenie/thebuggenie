...
<?php else: ?>
	...
	<a href="javascript:void(0);" onclick="$('team_<?php echo $team->getID() . "_" . $rnd_no; ?>').toggle();" style="font-weight: normal;"<?php if ($tbg_user->isMemberOfTeam($team)): ?> class="friend"<?php endif; ?>><?php echo $team->getName(); ?></a>
	<div id="team_<?php echo $team->getID() . '_' . $rnd_no; ?>" style="z-index: 100; width: 300px; display: none; position: absolute;" class="rounded_box white shadowed user_popup">
