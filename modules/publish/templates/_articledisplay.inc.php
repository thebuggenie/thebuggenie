...
<div class="article" style="width: auto; padding: 5px; position: relative;">
	<?php if ($show_title): ?>
		<div class="header">
			...
			<?php endif; ?>
			<?php if (BUGScontext::getCurrentProject() instanceof BUGSproject && (strpos($article->getName(), ucfirst(BUGScontext::getCurrentProject()->getKey())) == 0) || ($article->isCategory() && strpos($article->getName(), ucfirst(BUGScontext::getCurrentProject()->getKey())) == 9)): ?>
