...
<table style="margin-top: 0px; table-layout: fixed; width: 100%" cellpadding=0 cellspacing=0>
	<tr>
		...
		<td class="main_area article edit">
			<a name="top"></a>
			<?php if (isset($error)): ?>
				<div class="rounded_box red borderless" style="margin: 0 5px 5px 5px;">
			...
			<?php endif; ?>
			<?php if ($preview): ?>
				<div class="rounded_box yellow borderless" style="margin: 0 5px 5px 5px;">
					<b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
			...
			<?php endif; ?>
			<div class="rounded_box iceblue borderless" style="margin: 0 5px 5px 5px;">
				<b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
			...
			<form accept-charset="<?php echo TBGContext::getI18n()->getCharset(); ?>" action="<?php echo make_url('publish_article_edit', array('article_name' => $article_name)); ?>" method="post"
				...
				<div class="rounded_box lightgrey borderless" style="margin: 0 5px 5px 5px;">
					<b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
