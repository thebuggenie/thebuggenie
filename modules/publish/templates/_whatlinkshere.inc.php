            ...
            <ul class="article_list">
                <?php foreach ($whatlinkshere as $linking_article): ?>
                    <li>
                        ...
                        <?php echo link_tag(make_url('publish_article', array('article_name' => $linking_article->getName())), \thebuggenie\core\framework\Settings::get('allow_camelcase_links', 'publish', \thebuggenie\core\framework\Context::getScope()->getID(), 0) ? get_spaced_name($linking_article->getTitle()) : $linking_article->getTitle()); ?>
                        <br>
