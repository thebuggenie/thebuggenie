	...
	<tr>
		...
		<td class="main_area article edit">
			...
			<form accept-charset="<?php echo TBGContext::getI18n()->getCharset(); ?>" action="<?php echo make_url('publish_article_edit', array('article_name' => $article_name)); ?>" method="post">
				...
				<div class="faded_out dark" style="padding: 5px; font-size: 13px;"><?php echo __('For help and tips on how to format your article, see %wiki_formatting%', array('%wiki_formatting%' => link_tag(make_url('publish_article', array('article_name' => 'TheBugGenie:WikiFormatting')), 'WikiFormatting', array('target' => '_random_'.rand(1, 10000))))); ?></div>
