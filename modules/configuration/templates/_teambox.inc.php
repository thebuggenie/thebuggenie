<div class="rounded_box mediumgrey borderless" style="padding: 0; margin-top: 5px;" id="teambox_<?php echo $team->getID(); ?>">
	<div style="padding: 5px;">
		...
		<p class="teambox_membercount"><?php echo __('%number_of% member(s)', array('%number_of%' => $team->getNumberOfMembers())); ?></p>
		<div class="rounded_box white shadowed" style="margin: 5px; display: none;" id="clone_team_<?php echo $team->getID(); ?>">
			...
			<div class="dropdown_content">
				...
				<div style="text-align: right;">
					<?php echo javascript_link_tag(__('Clone this team'), array('onclick' => 'cloneTeam(\''.make_url('configure_users_clone_team', array('team_id' => $team->getID())).'\', '.$team->getID().');')); ?> :: <b><?php echo javascript_link_tag(__('Cancel'), array('onclick' => '$(\'clone_team_'.$team->getID().'\').toggle();')); ?></b>
				</div>
		...
		<div class="rounded_box white shadowed" style="margin: 5px; display: none;" id="confirm_team_<?php echo $team->getID(); ?>_delete">
			...
			<div class="dropdown_content">
				...
				<div style="text-align: right;">
					<?php echo javascript_link_tag(__('Yes'), array('onclick' => 'deleteTeam(\''.make_url('configure_users_delete_team', array('team_id' => $team->getID())).'\', '.$team->getID().');')); ?> :: <b><?php echo javascript_link_tag(__('No'), array('onclick' => '$(\'confirm_team_'.$team->getID().'_delete\').toggle();')); ?></b>
				</div>
