<div style="text-align: left;">
	...
	<?php if ($access_level == TBGSettings::ACCESS_FULL): ?>
		...
		<form action="<?php echo make_url('configure_project_updateother', array('project_id' => $project->getID())); ?>" method="post" style="margin-top: 10px;" onsubmit="thebuggenie.events.saveProjectOther('<?php echo make_url('configure_project_updateother', array('project_id' => $project->getID())); ?>');return false;" id="project_other">
	<?php else: ?>
