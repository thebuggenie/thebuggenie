<li class="hover_highlight issuefield_item_option" id="item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>" style="clear: both; height: 24px;">
	<div id="item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>_content">
		...
		<div class="button-group" style="float: right;">
			...
			<a href="javascript:void(0);" class="button button-icon button-silver" onclick="TBG.Main.Helpers.Backdrop.show('<?php echo make_url('get_partial_for_backdrop', array('key' => 'issuefield_permissions', 'item_id' => $item->getID(), 'item_name' => $item->getName(), 'item_key' => $item->getPermissionsKey(), 'access_level' => $access_level)); ?>');" title="<?php echo __('Set permissions for this item'); ?>"><?php echo image_tag('cfg_icon_permissions.png'); ?></a>
