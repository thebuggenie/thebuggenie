<tr class="hover_highlight" id="item_<?php echo $type; ?>_<?php echo $item->getID(); ?>">
	...
	<td style="width: 60px; padding: 2px; text-align: right;">
		...
		<?php else: ?>
			<a href="javascript:void(0);" onclick="TBG.Main.failedMessage('<?php echo __('This item cannot be deleted'); ?>', '<?php echo __('Other items - such as workflow steps - may depend on this item to exist. Remove the dependant item or unlink it from this item to continue.'); ?>');" class="image" id="delete_<?php echo $item->getID(); ?>_link"><?php echo image_tag('icon_delete_disabled.png'); ?></a>
		<?php endif; ?>
