<li class="hover_highlight issuefield_item_option" id="item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>" style="clear: both; height: 24px;">
	<div id="item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>_content">
		...
		<div class="button-group" style="float: right;">
			...
			<a href="javascript:void(0);" class="button button-icon button-silver" onclick="$('item_option_<?php echo $item->getID(); ?>_permissions').toggle();" title="<?php echo __('Set permissions for this item'); ?>"><?php echo image_tag('cfg_icon_permissions.png'); ?></a>
	...
	<div id="item_option_<?php echo $item->getID(); ?>_permissions" style="display: none;">
		<td colspan="3">
