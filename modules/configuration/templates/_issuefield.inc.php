...
<tr id="edit_item_<?php echo $item->getID(); ?>" style="display: none;">
	<td colspan="3">
		<form accept-charset="<?php echo TBGContext::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_issuefields_edit', array('type' => $type, 'id' => $item->getID())); ?>" onsubmit="thebuggenie.events.editIssuefieldOption('<?php echo make_url('configure_issuefields_edit', array('type' => $type, 'id' => $item->getID())); ?>', '<?php echo $type; ?>', <?php echo $item->getID(); ?>);return false;" id="edit_<?php echo $type; ?>_<?php echo $item->getID(); ?>_form">
		...
		<div class="rounded_box white shadowed" style="margin: 5px 0 10px 0; font-size: 12px;">
				...
				<div class="content">
					...
					<div style="text-align: right; font-size: 13px;">
						<a href="javascript:void(0);" onclick="thebuggenie.events.deleteIssuefieldOption('<?php echo make_url('configure_issuefields_delete', array('type' => $type, 'id' => $item->getID())); ?>', '<?php echo $type; ?>', <?php echo $item->getID(); ?>);"><?php echo __('Yes'); ?></a> ::
