	...
	<tr id="del_build_<?php print $b_id; ?>" class="selected_red" style="display: none;">
		<td colspan=3 style="border-bottom: 1px solid #E55; padding: 5px; height: 33px; font-size: 12px;">
			<div style="float: right;">
				...
				<button onclick="thebuggenie.events.deleteBuild('<?php echo make_url('configure_build_action', array('build_id' => $b_id, 'build_action' => 'delete')); ?>', <?php print $b_id; ?>);" style="font-size: 11px;"><?php echo __('Delete it'); ?></button>
			</div>
