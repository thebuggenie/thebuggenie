<div class="tab_menu">
	<ul id="project_config_menu">
		<li id="tab_information"<?php if ($selected_tab == 'info'): ?> class="selected"<?php endif; ?>><?php echo javascript_link_tag(image_tag('icon_edit.png', array('style' => 'float: left;')).__('Information'), array('onclick' => "TBG.Main.Helpers.tabSwitcher('tab_information', 'project_config_menu');")); ?></li>
		<li id="tab_settings"<?php if ($selected_tab == 'settings'): ?> class="selected"<?php endif; ?>><?php echo javascript_link_tag(image_tag('cfg_icon_projectsettings.png', array('style' => 'float: left;')).__('Settings'), array('onclick' => "TBG.Main.Helpers.tabSwitcher('tab_settings', 'project_config_menu');")); ?></li>
		<li id="tab_hierarchy"<?php if ($selected_tab == 'hierarchy'): ?> class="selected"<?php endif; ?>><?php echo javascript_link_tag(image_tag('cfg_icon_projecteditionsbuilds.png', array('style' => 'float: left;')).__('Hierarchy'), array('onclick' => "TBG.Main.Helpers.tabSwitcher('tab_hierarchy', 'project_config_menu');")); ?></li>
		<li id="tab_milestones"<?php if ($selected_tab == 'milestones'): ?> class="selected"<?php endif; ?>><?php echo javascript_link_tag(image_tag('icon_milestones.png', array('style' => 'float: left;')).__('Milestones'), array('onclick' => "TBG.Main.Helpers.tabSwitcher('tab_milestones', 'project_config_menu');")); ?></li>
