	...
	<tr>
		...
		<td valign="top">
			...
			<div style="width: 750px; clear: both; height: 30px;" class="tab_menu">
				<ul id="import_menu">
					<li id="tab_csv" class="selected"><?php echo javascript_link_tag(image_tag('icon_csv.png', array('style' => 'float: left; margin-right: 5px;')) . __('CSV'), array('onclick' => "TBG.Main.switchSubmenuTab('tab_csv', 'import_menu');")); ?></li>
					<li id="tab_tbg"><?php echo javascript_link_tag(image_tag('favicon.png', array('style' => 'float: left; margin-right: 5px;')) . __('BUGS 1.x/The Bug Genie 2'), array('onclick' => "TBG.Main.switchSubmenuTab('tab_tbg', 'import_menu');")); ?></li>
					<li id="tab_sample"><?php echo javascript_link_tag(image_tag('icon_project.png', array('style' => 'float: left; margin-right: 5px;')) . __('Sample data'), array('onclick' => "TBG.Main.switchSubmenuTab('tab_sample', 'import_menu');")); ?></li>
				</ul>
			</div>
			<div id="import_menu_panes">
				<div id="tab_csv_pane" style="padding-top: 0; width: 750px;">
					<div class="tab_content">
						...
						<ul>
							<li><a href="javascript:void(0);" onClick="TBG.Main.showFadedBackdrop('<?php echo make_url('configure_import_csv', array('type' => 'issues')); ?>');"><?php echo __('Issues'); ?></a></li>
							<li><a href="javascript:void(0);" onClick="TBG.Main.showFadedBackdrop('<?php echo make_url('configure_import_csv', array('type' => 'projects')); ?>');"><?php echo __('Projects'); ?></a></li>
							<!--<li><a href="javascript:void(0);" onClick="TBG.Main.showFadedBackdrop('<?php echo make_url('configure_import_csv', array('type' => 'users')); ?>');"><?php echo __('Users'); ?></a></li>
							<li><a href="javascript:void(0);" onClick="TBG.Main.showFadedBackdrop('<?php echo make_url('configure_import_csv', array('type' => 'teams')); ?>');"><?php echo __('Teams'); ?></a></li>-->
							<li><a href="javascript:void(0);" onClick="TBG.Main.showFadedBackdrop('<?php echo make_url('configure_import_csv', array('type' => 'clients')); ?>');"><?php echo __('Clients'); ?></a></li>
							<!--<li><a href="javascript:void(0);" onClick="TBG.Main.showFadedBackdrop('<?php echo make_url('configure_import_csv', array('type' => 'groups')); ?>');"><?php echo __('Groups'); ?></a></li>-->
						</ul>
			...
			<?php if (isset($imported_data)): ?>
				<script type="text/javascript">
					TBG.Main.successMessage('<?php echo __('Sample data loaded!'); ?>', '<?php echo __('Sample data was loaded. You can now browse around The Bug Genie and try it out!'); ?>');
				</script>
			<?php endif; ?>
		</td>
	</tr>
