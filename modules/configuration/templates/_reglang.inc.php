<table style="clear: both; width: 700px; margin-top: 5px;" class="padded_table" cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<td><input type="text" name="charset" id="charset" value="<?php echo TBGSettings::getCharset(); ?>" style="width: 150px;"<?php if ($access_level != configurationActions::ACCESS_FULL): ?> disabled<?php endif; ?>></td>
	</tr>
	<tr>
		<td class="config_explanation" colspan="2"><?php echo __('What charset to use for the selected language - leave blank to use the charset specified in the language file (currently %charset%)', array('%charset%' => '<b>' . TBGContext::getI18n()->getLangCharset() . '</b>')); ?></td>
	</tr>
	<tr>
