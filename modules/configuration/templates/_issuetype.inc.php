...
<?php endif; ?>
	...
	<div class="header">
		...
		<?php if (!isset($scheme) || !$scheme->isCore()): ?>
			...
			<a title="<?php echo __('Delete issue type'); ?>" href="javascript:void(0);" onclick="thebuggenie.events.deleteIssuetype('<?php echo make_url('configure_issuetypes_delete', array('id' => $type->getID())); ?>', <?php echo $type->getID(); ?>)" class="image" style="float: right; margin-right: 5px;"><?php echo image_tag('icon_delete.png'); ?></a>
