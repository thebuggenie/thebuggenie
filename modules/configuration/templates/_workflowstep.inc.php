<tr class="step">
	<td>
		<?php echo link_tag(make_url('configure_workflow_step', array('workflow_id' => $step->getWorkflow()->getID(), 'step_id' => $step->getID())), $step->getName(), array('class' => 'step_name')); ?>
	...
	<td class="workflow_step_actions">
		...
		<?php else: ?>
			...
			<?php if ($step->getNumberOfIncomingTransitions()): ?>
			...
			<?php endif; ?>
			<?php echo javascript_link_tag(__('Add transition'), array('onclick' => "$('step_{$step->getID()}_transition_add').toggle()")); ?> | <a href="#"><?php echo __('Delete transitions'); ?></a>
		<?php endif; ?>
	</td>
</tr>