...
<td valign="top">
	...
	<div style="width: 700px; padding: 5px 0 5px 0; border-bottom: 1px solid #DDD; font-size: 14px;"><b><?php echo __('Existing projects'); ?></b></div>
	<div id="project_table">
	<?php if (count($allProjects) > 0): ?>
		<?php foreach ($allProjects as $aProject): ?>
			<?php include_template('projectbox', array('project' => $aProject)); ?>
		<?php endforeach; ?>
	<?php endif; ?>
	</div>
