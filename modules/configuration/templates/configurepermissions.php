				...
				<div id="permissions_tabs_panes" class="permission_list">
					<div id="tab_general_pane" class="tab_pane">
						...
						<ul>
							...
							<?php include_template('configuration/permissionsblock', array('base_id' => 'user_permissions', 'permissions_list' => BUGScontext::getAvailablePermissions('user'), 'mode' => 'user', 'target_id' => 0, 'module' => 'core', 'access_level' => $access_level)); ?>
