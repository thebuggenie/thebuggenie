...
<td valign="top">
	...
	<table style="width: 700px; margin-top: 10px;" cellpadding=0 cellspacing=0>
		...
		<tr>
			...
			<div class="config_header nobg" style="margin-top: 10px;"><?php echo tbg_helpBrowserHelper('setup_releases', image_tag('help.png', array('style' => "float: right;"))); ?><b><?php echo __('Builds / releases'); ?></b></div>
