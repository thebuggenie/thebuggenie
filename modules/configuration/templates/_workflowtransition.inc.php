	...
	<div class="rounded_box white shadowed" style="position: absolute; width: 285px; display: none;" id="delete_transition_<?php echo $transition->getID(); ?>_confirm">
		...
		<div class="content">
			...
			<div style="text-align: right;">
				<?php echo javascript_link_tag(__('Yes'), array('onclick' => "thebuggenie.events.deleteTransition('".make_url('configure_workflow_delete_transition', array('workflow_id' => $transition->getWorkflow()->getID(), 'transition_id' => $transition->getID()))."', {$transition->getID()}, '{$direction}');")); ?> ::
