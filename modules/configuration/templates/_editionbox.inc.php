<tr id="edition_box_<?php echo $edition->getID(); ?>" class="hover_highlight">
	...
	<td style="width: 60px; padding: 2px;">
		<?php echo javascript_link_tag(image_tag('icon_edit.png'), array('class' => 'image', 'onclick' => "thebuggenie.events.editEdition('".make_url('configure_project_edition', array('project_id' => $edition->getProject()->getID(), 'edition_id' => $edition->getID()))."', '".$edition->getID()."');", 'title' => __('Edit edition'))); ?>
