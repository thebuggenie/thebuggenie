<li id="edition_box_<?php echo $edition->getID(); ?>" class="rounded_box invisible borderless">
	<?php echo image_tag('icon_edition.png', array('style' => 'float: left; margin: 1px 5px 0 0;')); ?>
	<?php echo $edition->getName(); ?><?php if ($edition->isDefault()): echo __('%edition_name% (default)', array('%edition_name%' => '')); endif; ?>
