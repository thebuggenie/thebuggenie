<table style="clear: both; width: 700px; margin-top: 5px;" class="padded_table" cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<td><input type="text" onblur="$('server_path_warning_container').show();$('server_path_warning').highlight({ duration: 4});" onfocus="$('server_path_warning_container').show();$('server_path_warning').highlight({ duration: 4});" name="url_subdir" id="url_subdir" value="<?php echo TBGSettings::getURLsubdir(); ?>" style="width: 300px;"<?php if ($access_level != configurationActions::ACCESS_FULL): ?> disabled<?php endif; ?>></td>
	</tr>
