...
<div id="permissions_<?php echo $base_id; ?>_tabs_panes" class="permission_list">
	...
	<div id="<?php echo $base_id; ?>_tab_modules_pane" class="tab_pane" style="display: none;">
		...
		<?php foreach (TBGContext::getModules() as $module_key => $module): ?>
			<li>
				<a href="javascript:void(0);" onclick="$('<?php echo $base_id; ?>_module_permission_details_<?php echo $module_key; ?>').toggle();"><?php echo image_tag('icon_project_permissions.png', array('style' => 'float: right;')); ?><?php echo $module->getLongName(); ?> <span class="faded_out smaller"><?php echo $module_key; ?></span></a>
				<ul style="display: none;" id="<?php echo $base_id; ?>_module_permission_details_<?php echo $module_key; ?>">
