...
<div style="margin: 10px 0 0 0; clear: both; height: 30px;" class="tab_menu">
	<ul id="permissions_<?php echo $base_id; ?>_tabs">
		<li class="selected" id="<?php echo $base_id; ?>_tab_general"><a onclick="thebuggenie.events.switchSubmenuTab('<?php echo $base_id; ?>_tab_general', 'permissions_<?php echo $base_id; ?>_tabs');" href="javascript:void(0);"><?php echo __('General permissions'); ?></a></li>
		<li id="<?php echo $base_id; ?>_tab_pages"><a onclick="thebuggenie.events.switchSubmenuTab('<?php echo $base_id; ?>_tab_pages', 'permissions_<?php echo $base_id; ?>_tabs');" href="javascript:void(0);"><?php echo __('Page access permissions'); ?></a></li>
		<li id="<?php echo $base_id; ?>_tab_projects"><a onclick="thebuggenie.events.switchSubmenuTab('<?php echo $base_id; ?>_tab_projects', 'permissions_<?php echo $base_id; ?>_tabs');" href="javascript:void(0);"><?php echo __('Project-specific permissions'); ?></a></li>
		<li id="<?php echo $base_id; ?>_tab_modules"><a onclick="thebuggenie.events.switchSubmenuTab('<?php echo $base_id; ?>_tab_modules', 'permissions_<?php echo $base_id; ?>_tabs');" href="javascript:void(0);"><?php echo __('Module-specific permissions'); ?></a></li>
	</ul>
</div>
