...
<table style="clear: both; width: 700px; margin-top: 5px;" class="padded_table" cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<td>
			<select name="<?php echo TBGSettings::SETTING_GUEST_CAPTCHA; ?>" id="guestcaptcha" style="width: 400px;"<?php if ($access_level != TBGSettings::ACCESS_FULL): ?> disabled<?php endif; ?>>
				<option value=1<?php if (TBGSettings::isGuestCaptchaEnabled()): ?> selected<?php endif; ?>><?php echo __('Guests must enter a captcha when reporting issues or posting commments.'); ?></option>
				<option value=0<?php if (!TBGSettings::isGuestCaptchaEnabled()): ?> selected<?php endif; ?>><?php echo __('Guests can report issues or post comments without captcha.'); ?></option>
			</select>
		</td>
	</tr>
	<tr>
