...
<table style="clear: both; width: 700px; margin-top: 5px;" class="padded_table" cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<td><input type="text" name="limit_registration" id="limit_registration"<?php if ($access_level != configurationActions::ACCESS_FULL): ?> disabled<?php endif; ?> value="<?php echo TBGSettings::getRegistrationDomainWhitelist(); ?>" style="width: 300px;"></td>
	</tr>
	<tr>
