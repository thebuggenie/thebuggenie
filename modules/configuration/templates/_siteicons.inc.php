<div class="backdrop_box large">
	<div class="backdrop_detail_header">
		<?php echo __('Update header icon and favicon'); ?>
	</div>
	<div id="backdrop_detail_content" class="backdrop_detail_content">
		<form accept-charset="<?php echo TBGContext::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_site_icons'); ?>" method="post" id="build_form" onsubmit="$('update_icons_indicator').show();return true;" enctype="multipart/form-data">
				...
				<tr>
					<td style="width: 460px; padding-right: 10px;">
						...
						<div style="text-align: center; padding: 30px; height: 60px;">
							<?php echo image_tag(TBGSettings::getFaviconUrl(), array('style' => 'width: 16px; height: 16px;'), TBGSettings::isUsingCustomFavicon()); ?>
						</div>
						<div class="rounded_box lightgrey borderless" style="margin: 5px 0;">
							<ul class="simple_list" style="margin-top: 0;">
								...
								<?php if (TBGSettings::isUsingCustomFavicon()): ?>
					...
					<td style="width: 460px;">
						...
						<div style="text-align: center; padding: 30px; height: 60px;">
							<?php echo image_tag(TBGSettings::getHeaderIconUrl(), array('style' => 'width: 24px; height: 24px;'), TBGSettings::isUsingCustomHeaderIcon()); ?>
						</div>
						<div class="rounded_box lightgrey borderless" style="margin: 5px 0;">
							<ul class="simple_list" style="margin-top: 0;">
								...
								<?php if (TBGSettings::isUsingCustomHeaderIcon()): ?>
