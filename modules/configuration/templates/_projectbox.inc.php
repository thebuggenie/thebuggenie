...
<div id="project_box_<?php echo $project->getID();?>" class="rounded_box round_canhover lightgrey projectbox" style="margin: 10px 0px 10px 0px; width: 788px;">
