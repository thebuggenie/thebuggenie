	...
	<tr>
		...
		<?php if (!$project->isEditionsEnabled() && $project->isBuildsEnabled()): ?>
			<div style="float: right;">
				<span style="margin-right: 10px;"><strong><?php echo javascript_link_tag(image_tag('cfg_icon_builds.png', array('title' => (($access_level == TBGSettings::ACCESS_FULL) ? __('Manage releases') : __('Show releases')), 'style' => 'float: left; margin-right: 5px;')) . (($access_level == TBGSettings::ACCESS_FULL) ? __('Manage releases') : __('Show releases')), array('onclick' => "thebuggenie.events.showFadedBackdrop('".make_url('get_partial_for_backdrop', array('key' => 'project_config', 'section' => 'hierarchy', 'project_id' => $project->getID()))."');", 'style' => 'font-size: 12px;')); ?></strong></span>
			</div>
		<?php endif; ?>
			<div style="float: right;">
				<span style="margin-right: 10px;"><strong><?php echo javascript_link_tag(image_tag('cfg_icon_projectsettings.png', array('title' => (($access_level == TBGSettings::ACCESS_FULL) ? __('Edit project') : __('Show project details')), 'style' => 'float: left; margin-right: 5px;')) . (($access_level == TBGSettings::ACCESS_FULL) ? __('Edit project') : __('Show project details')), array('onclick' => "thebuggenie.events.showFadedBackdrop('".make_url('get_partial_for_backdrop', array('key' => 'project_config', 'project_id' => $project->getID()))."');", 'style' => 'font-size: 12px;')); ?></strong></span>
			</div>
			...
			<?php foreach ($project->getEditions() as $edition): ?>
				<tr class="hover_highlight">
					<td style="width: auto; padding: 3px 0 3px 5px;">
						<div style="float: right;"><span style="margin-right: 10px;"><?php echo javascript_link_tag(image_tag('cfg_icon_builds.png', array('title' => (($access_level == TBGSettings::ACCESS_FULL) ? __('Manage releases') : __('Show releases')), 'style' => 'float: left; margin-right: 5px;')) . (($access_level == TBGSettings::ACCESS_FULL) ? __('Manage releases') : __('Show releases')), array('onclick' => "thebuggenie.events.showFadedBackdrop('".make_url('get_partial_for_backdrop', array('key' => 'project_config', 'edition_id' => $edition->getID(), 'section' => 'releases', 'project_id' => $project->getID()))."');", 'style' => 'font-size: 12px;')); ?></span></div>
						<div style="float: right;"><span style="margin-right: 20px;"><?php echo javascript_link_tag(image_tag('cfg_icon_editiondetails.png', array('title' => (($access_level == TBGSettings::ACCESS_FULL) ? __('Edit details') : __('Show details')), 'style' => 'float: left; margin-right: 5px;')) . (($access_level == TBGSettings::ACCESS_FULL) ? __('Edit details') : __('Show details')), array('onclick' => "thebuggenie.events.showFadedBackdrop('".make_url('get_partial_for_backdrop', array('key' => 'project_config', 'edition_id' => $edition->getID(), 'project_id' => $project->getID()))."');", 'style' => 'font-size: 12px;')); ?></span></div>
