...
<?php if ($access_level == TBGSettings::ACCESS_FULL): ?>
	<form accept-charset="<?php echo TBGContext::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_settings'); ?>" method="post" onsubmit="TBG.Main.formSubmitHelper('<?php echo make_url('configure_settings'); ?>', 'config_settings'); return false;" id="config_settings">
<?php endif; ?>
<div style="margin-top: 5px; width: 750px; clear: both; height: 30px;" class="tab_menu">
	<ul id="settings_menu">
		<li class="selected" id="tab_general_settings"><a onclick="TBG.Main.switchSubmenuTab('tab_general_settings', 'settings_menu');" href="javascript:void(0);"><?php echo image_tag('cfg_icon_general.png', array('style' => 'float: left;')).__('General'); ?></a></li>
		<li id="tab_appearance_settings"><a onclick="TBG.Main.switchSubmenuTab('tab_appearance_settings', 'settings_menu');" href="javascript:void(0);"><?php echo image_tag('cfg_icon_appearance.png', array('style' => 'float: left;')).__('Appearance'); ?></a></li>
		<li id="tab_reglang_settings"><a onclick="TBG.Main.switchSubmenuTab('tab_reglang_settings', 'settings_menu');" href="javascript:void(0);"><?php echo image_tag('cfg_icon_reglang.png', array('style' => 'float: left;')).__('Regional &amp; language'); ?></a></li>
		<li id="tab_user_settings"><a onclick="TBG.Main.switchSubmenuTab('tab_user_settings', 'settings_menu');" href="javascript:void(0);"><?php echo image_tag('cfg_icon_users.png', array('style' => 'float: left;')).__('Users &amp; security'); ?></a></li>
	</ul>
</div>
