<div class="rounded_box white borderless shadowed backdrop_box large" style="text-align: left;">
	...
	<div id="backdrop_detail_content">
		...
		<form accept-charset="<?php echo TBGContext::getI18n()->getCharset(); ?>" method="post" id="import_csv_form" onsubmit="thebuggenie.events.importCSV('<?php echo make_url('configure_do_import_csv', array('type' => $type)); ?>');return false;">
