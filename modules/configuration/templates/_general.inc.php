<table style="clear: both; width: 700px; margin-top: 5px;" class="padded_table" cellpadding=0 cellspacing=0>
	<tr>
		...
		<td style="width: auto;"><input type="text" name="b2_name" id="b2_name" value="<?php echo str_replace('"', '&quot;', TBGSettings::getTBGname()); ?>" style="width: 100%;"<?php if ($access_level != configurationActions::ACCESS_FULL): ?> disabled<?php endif; ?>></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="b2_tagline" id="b2_tagline" value="<?php echo str_replace('"', '&quot;', TBGSettings::getTBGtagline()); ?>" style="width: 100%;"<?php if ($access_level != configurationActions::ACCESS_FULL): ?> disabled<?php endif; ?>></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<input type="text" style="width: 50px;"<?php if ($access_level != configurationActions::ACCESS_FULL): ?> disabled<?php endif; ?> name="highlight_default_interval" id="highlight_default_interval" value="<?php echo (TBGSettings::get('highlight_default_interval')); ?>" />
		</td>
	</tr>
	<tr>
