<div style="vertical-align: middle; padding: 5px; text-align: center;">
	<form accept-charset="<?php echo TBGContext::getI18n()->getCharset(); ?>" action="<?php echo make_url('reset_password', array('user' => str_replace('.', '%2E', $username), 'id' => $id)); ?>" method="post" id="forgot_password_form" onsubmit="resetForgotPassword('<?php echo make_url('reset_password', array('user' => str_replace('.', '%2E', $username), 'id' => $id)); ?>'); return false;">
