<div style="font-family: 'Trebuchet MS', 'Liberation Sans', 'Bitstream Vera Sans', 'Luxi Sans', Verdana, sans-serif; font-size: 11px; color: #646464;">
	...
	Your user (%user_username%) registered at %thebuggenie_url% has been added to a new scope in The Bug Genie.<br>
	<br>
	...
	<br>
	To accept (or reject) this invitation, go to %thebuggenie_url% and log in to your account.<br>
