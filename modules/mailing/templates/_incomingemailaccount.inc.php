<div id="incoming_email_account_<?php echo $account->getID(); ?>">
	<h5>
		<div class="button button-silver" style="float: right; margin-top: 5px;"><span onclick="TBG.Main.Helpers.Backdrop.show('<?php echo make_url('get_partial_for_backdrop', array('key' => 'mailing_editincomingemailaccount', 'project_id' => $account->getProject()->getId(), 'account_id' => $account->getID())); ?>');"><?php echo __('Edit'); ?></span></div>
		<div class="button button-green" style="float: right; margin-top: 5px;"><span onclick="TBG.Modules.mailing.checkIncomingAccount('<?php echo make_url('mailing_check_account', array('account_id' => $account->getID())); ?>');"><?php echo __('Check now'); ?></span></div>
