Hi, %user_buddyname%!
Your user (%user_username%) registered at %thebuggenie_url% has been added to a new scope in The Bug Genie.
...
To accept (or reject) this invitation, go to %thebuggenie_url% and log in to your account.
