<div style="font-family: 'Trebuchet MS', 'Liberation Sans', 'Bitstream Vera Sans', 'Luxi Sans', Verdana, sans-serif; font-size: 11px; color: #646464;">
	<b>Vous avez oubli&eacute; votre mot de passe ?</b><br>
	...
	Pour changer votre mot de passe, suivez ce lien :<br>
	<a href="%link_to_reset_password%">%link_to_reset_password%</a><br>
	<br>
	<i>Si vous n'avez pas demand&eacute; cet email, alors n'en tenez pas compte. Aucune action ne sera effectu&eacute; sauf si vous activez ce lien.</i>
</div>