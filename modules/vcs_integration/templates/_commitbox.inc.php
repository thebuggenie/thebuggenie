...
?>
<div class="comment commit" id="commit_<?php echo $commit->getID(); ?>">
    <div style="position: relative; overflow: visible; padding: 5px;" id="commit_view_<?php echo $commit->getID(); ?>" class="comment_main">
        <div id="commit_<?php echo $commit->getID(); ?>_header" class="commentheader">
            ...
            <div class="commenttitle">
                <?php if ($branchname !== null): ?><span class="commitbranch"><?php echo $branchname; ?></span> <?php endif; ?><?php echo __('Revision %rev by %user', array('%rev' => "<a href=".$link_rev.">".$commit->getRevision()."</a>", '%user' => '<div style="display: inline;">'.get_component_html('main/userdropdown', array('user' => $commit->getAuthor(), 'size' => 'large')).'</div>')); ?>
            </div>
