...
<div style="margin-top: 5px; width: 750px; clear: both; height: 30px;" class="tab_menu">
	<ul id="vcsintegration_settings_menu">
		<li class="selected" id="tab_general_settings"><a onclick="TBG.Main.switchSubmenuTab('tab_general_settings', 'vcsintegration_settings_menu');" href="javascript:void(0);"><?php echo image_tag('cfg_icon_general.png', array('style' => 'float: left;')).__('General settings'); ?></a></li>
		<li id="tab_project_settings"><a onclick="TBG.Main.switchSubmenuTab('tab_project_settings', 'vcsintegration_settings_menu');" href="javascript:void(0);"><?php echo image_tag('cfg_icon_projects.png', array('style' => 'float: left;')).__('Project settings'); ?></a></li>
	</ul>
</div>
