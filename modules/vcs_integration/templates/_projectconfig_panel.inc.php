		...
		<input type="hidden" name="project_id" value="<?php echo $project->getID(); ?>">
			...
			<div id="vcs_config_menu_panes">
				<div id="tab_vcs_general_pane">
					...
					<table style="clear: both; width: 780px; margin-top: 10px" class="padded_table" cellpadding=0 cellspacing=0>
						<tr>
							...
							<td style="width: 580px;">
								<input type="text" name="match_keywords" id="match_keywords" value="<?php echo TBGSettings::get('match_keywords_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100%;">
							</td>
						</tr>
						<tr>
					...
					<table style="clear: both; width: 780px;" class="padded_table" cellpadding=0 cellspacing=0>
						<tr>
							...
							<td style="width: 580px;">
								<select name="access_method" id="access_method">
									<option value="0"<?php if (TBGSettings::get('access_method_'.$project->getID(), 'vcs_integration') == 0): ?> selected="selected"<?php endif;?>><?php echo __('Direct Access (via a call to tbg_cli)'); ?></option>
									<option value="1"<?php if (TBGSettings::get('access_method_'.$project->getID(), 'vcs_integration') == 1): ?> selected="selected"<?php endif;?>><?php echo __('HTTP Access (via a call to a URL'); ?></option>
								</select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="width: 580px; position: relative;">
								<input type="text" name="access_passkey" id="access_passkey" value="<?php echo TBGSettings::get('access_passkey_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100%;">
							</td>
						</tr>
					</table>
				...
				<div id="tab_vcs_browser_pane" style="display: none">
					<?php echo __('On this page you can set the URLs generated for links to commit details. If you are setting up for the first time, you may want to select the repository browser you use, as this will automatically set the URLs.'); ?>
					<table style="clear: both; width: 780px;" class="padded_table" cellpadding=0 cellspacing=0>
						<tr>
							<td style="width: 200px;"><label for="browser_url"><?php echo __('URL to repository browser'); ?></label></td>
							<td style="width: 580px; position: relative;">
								<input type="text" name="browser_url" id="browser_url" value="<?php echo TBGSettings::get('browser_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100%;">
							</td>
						</tr>
						<tr>
							...
							<td style="width: 580px; position: relative;">
								<select name="browser_type" id="browser_type" onchange="if ($('browser_type').getValue() == 'websvn' || $('browser_type').getValue() == 'websvn_mv') { $('repository_box').show(); } else { $('repository_box').hide(); } if ($('browser_type').getValue() == 'other') { $('vcs_custom_urls').show(); } else { $('vcs_custom_urls').hide(); }">
									<optgroup label="<?php echo __('Multi-system'); ?>">
										...
										<option value='other' selected="selected">Other - <?php echo __('Set URLs manually'); ?></option>
									</optgroup>
							...
							<td colspan="2" id="vcs_custom_urls">
								...
								<table style="clear: both; width: 780px; margin-top: 10px" class="padded_table" cellpadding=0 cellspacing=0>
									<tr>
										...
										<td style="width: 580px; position: relative;">
											<input type="text" name="commit_url" id="commit_url" value="<?php echo TBGSettings::get('commit_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100%;">
										</td>
									</tr>
									<tr>
										<td style="width: 200px;"><label for="log_url"><?php echo __('File log page'); ?></label></td>
										<td style="width: 580px; position: relative;">
											<input type="text" name="log_url" id="log_url" value="<?php echo TBGSettings::get('log_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100%;">
										</td>
									</tr>
									<tr>
										<td style="width: 200px;"><label for="blob_url"><?php echo __('File blob/view page'); ?></label></td>
										<td style="width: 580px; position: relative;">
											<input type="text" name="blob_url" id="blob_url" value="<?php echo TBGSettings::get('blob_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100%;">
										</td>
									</tr>
									<tr>
										<td style="width: 200px;"><label for="diff_url"><?php echo __('Diff page'); ?></label></td>
										<td style="width: 580px; position: relative;">
											<input type="text" name="diff_url" id="diff_url" value="<?php echo TBGSettings::get('diff_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100%;">
										</td>
									</tr>
								</table>
							</td>
