...
<?php else: ?>
	<div class="donate installation_box">
		...
		<div style="margin-top: 10px; margin-bottom: 10px; font-size: 13px;"><a target="_new" href="http://thebuggenie.com/support">http://thebuggenie.com/support</a> <span style="font-size: 10px;">(opens in a new window)</span></div>
	</div>
	<div class="installation_box">
		...
		<b>Commercial email support is available for anyone with a <a target="_new" href="http://thebuggenie.com/support">support contract</a>.</b> For other inquiries, send an email to <a href="mailto:support@thebuggenie.com">support@thebuggenie.com</a>.
	</div>
