...
<?php else: ?>
	<div class="donate installation_box">
		...
		<div style="margin-top: 10px; margin-bottom: 10px; font-size: 13px;"><a target="_new" href="http://www.thebuggenie.com/support">http://www.thebuggenie.com/support</a> <span style="font-size: 10px;">(opens in a new window)</span></div>
	</div>
	<div class="installation_box">
		...
		Online documentation is available from <a href="http://www.thebuggenie.com/support" target="_new">www.thebuggenie.com -> support</a>. If you need more help, you can use the <a href="http://forum.thebuggenie.com" target="_new">forums</a> where there are a lot of helpful people around.<br>
		<b>Commercial email support is available for anyone with a <a target="_new" href="http://www.thebuggenie.com/support">support contract</a>.</b> For other inquiries, send an email to <a href="mailto:support@thebuggenie.com">support@thebuggenie.com</a>.
	</div>
