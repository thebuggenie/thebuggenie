<li id="issue_<?php echo $issue->getID(); ?>_top_container" class="milestone_issue <?php if ($issue->isChildIssue() && !$issue->hasParentIssuetype($board->getEpicIssuetypeID())) echo 'child_issue'; ?> <?php if ($issue->isClosed()) echo 'issue_closed'; ?> <?php if ($issue->hasChildIssues()) echo 'has_child_issues'; ?>" data-issue-id="<?php echo $issue->getID(); ?>"<?php
