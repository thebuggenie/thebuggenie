    ...
    <div class="milestone_counts_container">
        <table>
            <tr>
                ...
                <td id="milestone_<?php echo $milestone->getID(); ?>_hours_count" class="issue_estimates"><?php echo ($include_counts) ? $milestone->getHoursAndMinutesSpent(true) .'/'. $milestone->getHoursAndMinutesEstimated(true) : '-'; ?></td>
            </tr>
            <tr>
