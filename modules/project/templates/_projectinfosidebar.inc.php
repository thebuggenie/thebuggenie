	...
	<tr>
		<td class="project_information_sidebar" id="project_information_sidebar">
			<div id="project_header_container">
				...
				<div>
					<?php if ($tbg_user->canEditProjectDetails($selected_project)): ?><?php echo javascript_link_tag(image_tag('cfg_icon_projectheader.png', array('class' => 'config_link')), array('onclick' => "TBG.Main.showFadedBackdrop('".make_url('get_partial_for_backdrop', array('key' => 'project_config', 'project_id' => $selected_project->getID()))."');")); ?><?php endif; ?>
					<div id="project_name">
