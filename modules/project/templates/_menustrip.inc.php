<div class="menu_project_strip tab_menu">
	<div class="project_name<?php if (!$project instanceof BUGSproject): ?> faded_dark<?php endif; ?>">
		...
		<span id="project_menustrip_name">
			<a href="javascript:void(0);" onclick="$('project_menustrip_change').toggle();" style="float: right; margin-left: 10px;<?php if ($bugs_response->getPage() != 'reportissue' && $show_report_button && count(BUGSproject::getAll()) <= 1): ?> display: none;<?php endif; ?>" class="image"><?php echo image_tag('expand.png'); ?></a>
