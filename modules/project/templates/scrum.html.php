...
?>
		...
		<div id="scrum_sprints" class="scrum_container">
			...
			<?php endif; ?>
			<?php if ($tbg_user->canEditProjectDetails($selected_project)): ?><div class="faded_out" style="margin-top: 10px;"><?php echo __("Sprints are created as milestones for this project, which can be edited in the %project_configuration%.", array('%project_configuration%' => javascript_link_tag(__('project configuration'), array('onclick' => "TBG.Main.showFadedBackdrop('".make_url('get_partial_for_backdrop', array('key' => 'project_config', 'section' => 'milestones', 'project_id' => $selected_project->getID()))."');")))); ?></div><?php endif; ?>
