			...
			<div style="width: 680px; padding-right: 5px;">
				...
				<div style="clear: both; height: 30px;" class="tab_menu">
					<ul id="project_dashboard_menu">
						<li class="selected" id="tab_10_recent_issues"><a onclick="TBG.Main.switchSubmenuTab('tab_10_recent_issues', 'project_dashboard_menu');" href="javascript:void(0);"><?php echo __('Recent issues / bugs'); ?></a></li>
						<li id="tab_5_recent_requests"><a onclick="TBG.Main.switchSubmenuTab('tab_5_recent_requests', 'project_dashboard_menu');" href="javascript:void(0);"><?php echo __('Recent feature requests'); ?></a></li>
						<li id="tab_recent_ideas"><a onclick="TBG.Main.switchSubmenuTab('tab_recent_ideas', 'project_dashboard_menu');" href="javascript:void(0);"><?php echo __('Recent ideas'); ?></a></li>
						<li id="tab_statistics"><a onclick="TBG.Main.switchSubmenuTab('tab_statistics', 'project_dashboard_menu');" href="javascript:void(0);"><?php echo __('Statistics'); ?></a></li>
					</ul>
				</div>
