...
<?php if ($tbg_user->canEditProjectDetails($selected_project)): ?>
	...
	<?php if (!($submenu) && $tbg_response->getPage() == 'project_settings'): ?>
		...
		<ul class="simple_list" id="project_config_menu">
			...
			<li id="tab_planning"<?php if ($selected_tab == 'planning'): ?> class="selected"<?php endif; ?>><?php echo javascript_link_tag(__('Planning settings'), array('onclick' => "TBG.Main.Helpers.tabSwitcher('tab_planning', 'project_config_menu');")); ?></li>
