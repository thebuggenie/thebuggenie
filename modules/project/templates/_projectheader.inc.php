<div class="project_header">
	<div class="project_header_right">
		<div class="button button-orange small-button"><span><?php echo image_tag('icon_download.png').__('Download'); ?></span></div>
		<?php if (TBGContext::getUser()->canReportIssues($selected_project)): ?>
			<div class="button button-green small-button report_button" style="overflow: visible;">
		...
		<?php if ($tbg_user->canEditProjectDetails($selected_project)): ?>
			<div onclick="$('project_settings_popout').toggle();" class="button button-silver small-button config_link" title="<?php echo __('Edit project settings'); ?>"><span><?php echo image_tag('cfg_icon_projectheader.png').' '.__('Configure'); ?></span></div>
			<div id="project_settings_popout" class="smaller_buttons rounded_box shadowed white" style="display: none; width: 500px; text-align: center; position: absolute; right: 15px; top: 125px; padding: 6px;">
