<div class="project_header">
	<div class="project_header_right">
		...
		<?php if ($tbg_user->canEditProjectDetails($selected_project) && $tbg_response->getPage() != 'project_settings'): ?>
			<div class="button button-silver config_link" title="<?php echo __('Edit project settings'); ?>"><?php echo link_tag(make_url('project_settings', array('project_key' => $selected_project->getKey())), '<span>'.image_tag('icon_edit.png').__('Edit project').'</span>'); ?></div>
