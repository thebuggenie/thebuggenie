<div class="header" id="milestone_<?php echo $milestone->getID(); ?>_header">
	<div class="button-group" style="float: right;">
		...
		<?php echo javascript_link_tag(__('Issues'), array('onclick' => "TBG.Project.Planning.toggleIssues('".make_url('project_planning_milestone_issues', array('project_key' => $milestone->getProject()->getKey(), 'milestone_id' => $milestone->getID()))."', {$milestone->getID()}, '".make_url('project_planning_milestone_sort_issues', array('project_key' => $milestone->getProject()->getKey(), 'milestone_id' => $milestone->getID()))."');", 'class' => 'button button-silver', 'title' => __('Click to show assigned stories for this milestone'))); ?>
		<?php if ($milestone->getID()): ?>
			<?php if ($tbg_user->canEditProjectDetails(TBGContext::getCurrentProject())): ?>
				<?php echo javascript_link_tag(__('More actions'), array('class' => 'dropper button button-silver', 'id' => "milestone_{$milestone->getID()}_reload_button", 'title' => __('Click to show more actions for this milestone'))); ?>
