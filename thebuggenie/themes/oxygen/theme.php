<?php
	...
	TBGContext::getResponse()->addStylesheet(TBGContext::getStrippedTBGPath().'/fonts/droidsans/stylesheet.css', false);
	...
	TBGContext::getResponse()->addStylesheet('markitup.css');