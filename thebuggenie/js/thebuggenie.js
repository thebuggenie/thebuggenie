...
jQuery(document).ready(function () {
    ...
    (function ($) {
        $("body").on("click", ".dropper", function (e) {
            var is_visible = $(this).hasClass('button-pressed');
            TBG.Main.Profile.clearPopupsAndButtons();
            if (!is_visible) {
        ...
        $("body").on("click", ".fancydropdown-item", function (e) {
            TBG.Main.setFancyDropdownValue(this);
        });
        $("body").on("click", ".dropper.dynamic_menu_link", function (e) {
            var menu = $(this).next()[0];
