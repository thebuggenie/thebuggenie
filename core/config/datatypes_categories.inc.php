...
<tr>
<td valign="middle" class="cleft" style="width: 20px;"><?php echo image_tag('cfg_icon_categories.png'); ?></td>
<td valign="middle" class="cright" style="width: auto;"><b><?php echo __('Categories'); ?></b></td>
</tr>
</table>
...
<?php
	...
	$include_table = true;
	foreach (BUGSdatatype::getAll(BUGSdatatype::CATEGORY) as $aListType)
	{
		$aDatatype = BUGSfactory::datatypeLab($aListType, BUGSdatatype::CATEGORY);
...
<?php
	if ($access_level == "full")
	{
		...
		<input type="hidden" name="datatype" value="<?php echo BUGSdatatype::CATEGORY; ?>">
