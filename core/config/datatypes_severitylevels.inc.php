...
<tr>
<td valign="middle" class="cleft" style="width: 20px;"><?php echo image_tag('cfg_icon_severities.png', 'align="left"'); ?></td>
<td valign="middle" class="cright" style="width: auto;"><b><?php echo __('Severity levels'); ?></b></td>
</tr>
</table>
...
<?php
	...
	$include_table = true;
	foreach (BUGSdatatype::getAll(BUGSdatatype::SEVERITY) as $aListType)
	{
		$aDatatype = BUGSfactory::datatypeLab($aListType, BUGSdatatype::SEVERITY);
...
<?php
	if ($access_level == "full")
	{
		...
		<input type="hidden" name="datatype" value="<?php echo BUGSdatatype::SEVERITY; ?>">
