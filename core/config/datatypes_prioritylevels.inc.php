...
<tr>
<td valign="middle" class="cleft" style="width: 20px;"><?php echo image_tag('cfg_icon_priorities.png'); ?></td>
<td valign="middle" class="cright" style="width: auto;"><b><?php echo __('Priority levels'); ?></b></td>
</tr>
</table>
...
<?php
	...
	$include_table = true;
	foreach (BUGSdatatype::getAll(BUGSdatatype::PRIORITY) as $aListType)
	{
		$aDatatype = BUGSfactory::datatypeLab($aListType, BUGSdatatype::PRIORITY);
...
<?php
	if ($access_level == "full")
	{
		...
		<input type="hidden" name="datatype" value="<?php echo BUGSdatatype::PRIORITY; ?>">
		...
		<tr>
		<td style="padding: 2px; width: 20px;"><input type="text" name="datatype_itemdata" value="" style="width: 100%;"></td>
