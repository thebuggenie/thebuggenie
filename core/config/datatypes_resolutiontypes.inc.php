...
<tr>
<td valign="middle" class="cleft" style="width: 20px;"><?php echo image_tag('cfg_icon_resolutiontypes.png'); ?></td>
<td valign="middle" class="cright" style="width: auto;"><b><?php echo __('Resolution types'); ?></b></td>
</tr>
</table>
...
<?php
	...
	$include_table = true;
	foreach (BUGSdatatype::getAll(BUGSdatatype::RESOLUTION) as $aListType)
	{
		$aDatatype = BUGSfactory::datatypeLab($aListType, BUGSdatatype::RESOLUTION);
...
<?php
	if ($access_level == "full")
	{
		...
		<input type="hidden" name="datatype" value="<?php echo BUGSdatatype::RESOLUTION; ?>">
