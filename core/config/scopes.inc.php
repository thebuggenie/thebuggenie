			...
			<td style="padding-right: 10px;">
				<table class="configstrip" cellpadding=0 cellspacing=0>
					...
					<tr>
						...
						<?php echo __('Scopes are individual BUGS 2 environments, fully functional, but invisible to eachother.'); echo __('You can learn more about scopes in the %tbg_online_help%.', array('%tbg_online_help%' => tbg_helpBrowserHelper('scopes', __('The Bug Genie online help')))); ?><br><?php echo __('Click on a scope to view its details and/or change its settings.'); ?><br>
						<br>
										...
										<div style="border-top: 1px solid #DDD; background-color: #F5F5F5; padding: 3px;">
											<table cellpadding=0 cellspacing=0 width="100%">
												<tr>
													...
													<td>
														<table cellpadding=0 cellspacing=0 width="100%">
														<?php print tbg_userDropdown($aScope->getScopeAdmin()); ?>
														</table>
													</td>
												</tr>
											</table>
									...
									if (!$newScope)
									{
										...
										<table cellpadding=0 cellspacing=0 style="width: 100%; table-layout: fixed;">
											<tr>
												...
												<?php tbg_AJAXuserteamselector(__('Set scope administrator'), 
																				'',
								...
								else
								{
									...
									<table cellpadding=0 cellspacing=0 width="100%">
										...
										<tr>
											...
											<td style="padding-top: 5px;"><table cellpadding=0 cellspacing=0 width="100%"><?php print tbg_userDropdown($theScope->getScopeAdmin()); ?></table></td>
										</tr>
									</table>
									</div>
									<?php
