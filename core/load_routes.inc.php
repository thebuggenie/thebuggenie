<?php
	...
	$routes[] = array('configure_build_delete', '/configure/project/:project_id/:build_id/delete', 'project', 'deleteBuild');
	...
	$routes[] = array('configure_update_component', '/configure/project/:project_id/component/:component_id/update', 'project', 'editComponent', array('config_module' => 'core', 'section' => TBGSettings::CONFIGURATION_SECTION_PROJECTS, 'mode' => 'update'));
	...
	$routes[] = array('configure_workflow_transition_add_validation_rule', '/configure/workflow/:workflow_id/transition/:transition_id/add/:postorpre/validationrule/:rule', 'configuration', 'configureWorkflowTransition', array('config_module' => 'core', 'section' => TBGSettings::CONFIGURATION_SECTION_WORKFLOW, 'mode' => 'new_validation_rule'));
	...
	$routes[] = array('configure_workflow_transition_add_action', '/configure/workflow/:workflow_id/transition/:transition_id/add/action/:action_type', 'configuration', 'configureWorkflowTransition', array('config_module' => 'core', 'section' => TBGSettings::CONFIGURATION_SECTION_WORKFLOW, 'mode' => 'new_action'));
	...
	$routes[] = array('configure_issuefields_saveorder', '/configure/issuefields/save/options/order/for/:type', 'configuration', 'configureIssuefieldsAction', array('config_module' => 'core', 'section' => TBGSettings::CONFIGURATION_SECTION_ISSUEFIELDS, 'mode' => 'saveorder'));
	...
	$routes[] = array('configure_users_remove_team_member', '/configure/users/remove/:user_id/from/team/:team_id', 'configuration', 'removeTeamMember', array('config_module' => 'core', 'section' => TBGSettings::CONFIGURATION_SECTION_USERS, 'format' => 'json'));
	$routes[] = array('configure_users_add_team_member', '/configure/users/add/user/:user_id/to/team/:team_id', 'configuration', 'addTeamMember', array('config_module' => 'core', 'section' => TBGSettings::CONFIGURATION_SECTION_USERS, 'format' => 'json'));
	...
	$routes[] = array('configure_users_remove_client_member', '/configure/users/remove/:user_id/from/client/:client_id', 'configuration', 'removeClientMember', array('config_module' => 'core', 'section' => TBGSettings::CONFIGURATION_SECTION_USERS, 'format' => 'json'));
	$routes[] = array('configure_users_add_client_member', '/configure/users/add/user/:user_id/to/client/:client_id', 'configuration', 'addClientMember', array('config_module' => 'core', 'section' => TBGSettings::CONFIGURATION_SECTION_USERS, 'format' => 'json'));
	...
	$routes[] = array('publish_special_whatlinkshere', '/wiki/Special:WhatLinksHere/:linked_article_name', 'publish', 'specialArticle', array('article_name' => 'Special:WhatLinksHere'));
