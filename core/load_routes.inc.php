<?php
	...
	$routes[] = array('configure_issuefields_add', '/configure/issuefields/add/:type', 'configuration', 'configureIssuefieldsAdd', array('config_module' => 'core', 'section' => 4));
	$routes[] = array('configure_issuefields_delete', '/configure/issuefields/delete/:type/:id', 'configuration', 'configureIssuefieldsDelete', array('config_module' => 'core', 'section' => 4));
