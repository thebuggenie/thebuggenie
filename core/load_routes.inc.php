<?php
	...
	$routes[] = array('getprojectmenustrip', '/getprojectmenustrip/on/page/:page', 'main', 'getProjectMenustrip');
	...
	$routes[] = array('issue_setfield', '/issue/:issue_id/set/:field/*', 'main', 'issueSetField');
	$routes[] = array('issue_revertfield', '/issue/:issue_id/revert/:field', 'main', 'issueRevertField');
	$routes[] = array('issue_startworking', '/issue/:issue_id/startworking', 'main', 'issueStartWorking');
