...
<div id="team_<?php echo $team->getID(); ?>_permissions_container" style="display: none;" class="fullpage_backdrop">
    <div class="fullpage_backdrop_content backdrop_box large">
        <div class="backdrop_detail_header">
            <span><?php echo __('Configure advanced permissions for %teamname', array('%teamname' => $team->getName())); ?></span>
            <?php echo javascript_link_tag(fa_image_tag('times'), array('class' => 'closer', 'onclick' => "$('team_".$team->getID()."_permissions_container').toggle();")); ?>
        </div>
