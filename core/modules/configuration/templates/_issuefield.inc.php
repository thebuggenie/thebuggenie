<li id="item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>" style="clear: both; height: 24px;">
    <div id="item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>_content">
        ...
        <div class="button-group" style="float: right;">
            <a href="javascript:void(0);" class="button button-icon button-silver" onclick="$('item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>_content').hide();$('edit_item_option_<?php echo $item->getID(); ?>').show();$('<?php echo $type; ?>_<?php echo $item->getID(); ?>_name_input').focus();" title="<?php echo __('Edit this item'); ?>"><?php echo fa_image_tag('pencil'); ?></a>
