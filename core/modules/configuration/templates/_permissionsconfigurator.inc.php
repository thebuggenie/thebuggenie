...
<div id="permissions_<?php echo $mode; ?>_<?php echo $base_id; ?>_tabs_panes" class="permission_list">
    <div id="<?php echo $mode.'_'.$base_id; ?>_tab_general_pane" class="tab_pane">
        ...
        <ul>
            <?php include_component('configuration/permissionsblock', array('base_id' => $mode.'_'.$base_id . 'general_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('general'), 'mode' => 'general', 'target_id' => 0, 'module' => 'core', 'user_id' => $user_id, 'team_id' => $team_id, 'access_level' => $access_level)); ?>
            <?php include_component('configuration/permissionsblock', array('base_id' => $mode.'_'.$base_id . 'user_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('user'), 'mode' => 'user', 'target_id' => 0, 'module' => 'core', 'user_id' => $user_id, 'team_id' => $team_id, 'access_level' => $access_level)); ?>
            <?php include_component('configuration/permissionsblock', array('base_id' => $mode.'_'.$base_id . 'issues_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('issues'), 'mode' => 'general', 'target_id' => 0, 'module' => 'core', 'user_id' => $user_id, 'team_id' => $team_id, 'access_level' => $access_level)); ?>
            <?php include_component('configuration/permissionsblock', array('base_id' => $mode.'_'.$base_id . 'project_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('project'), 'mode' => 'general', 'target_id' => 0, 'module' => 'core', 'user_id' => $user_id, 'team_id' => $team_id, 'access_level' => $access_level)); ?>
        </ul>
    </div>
    <div id="<?php echo $mode; ?>_<?php echo $base_id; ?>_tab_pages_pane" class="tab_pane" style="display: none;">
        ...
        <ul>
            <?php include_component('configuration/permissionsblock', array('base_id' => $mode.'_'.$base_id . 'page_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('pages'), 'mode' => 'pages', 'target_id' => 0, 'module' => 'core', 'user_id' => $user_id, 'team_id' => $team_id, 'access_level' => $access_level)); ?>
            <?php include_component('configuration/permissionsblock', array('base_id' => $mode.'_'.$base_id . 'configuration_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('configuration'), 'mode' => 'configuration', 'target_id' => 0, 'module' => 'core', 'user_id' => $user_id, 'team_id' => $team_id, 'access_level' => $access_level)); ?>
            <?php include_component('configuration/permissionsblock', array('base_id' => $mode.'_'.$base_id . 'project_page_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('project_pages'), 'mode' => 'project_pages', 'target_id' => 0, 'module' => 'core', 'user_id' => $user_id, 'team_id' => $team_id, 'access_level' => $access_level)); ?>
        </ul>
    </div>
                ...
                <?php foreach (TBGProject::getAll() as $project): ?>
                    <li>
                        ...
                        <ul style="display: none;" id="<?php echo $base_id; ?>_project_permission_details_<?php echo $project->getID(); ?>">
                            <?php include_component('configuration/permissionsblock', array('base_id' => $base_id . 'project_' . $project->getID() . '_project_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('project'), 'mode' => 'general', 'target_id' => $project->getID(), 'module' => 'core', 'user_id' => $user_id, 'access_level' => $access_level)); ?>
                            <?php include_component('configuration/permissionsblock', array('base_id' => $base_id . 'project_' . $project->getID() . '_page_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('project_pages'), 'mode' => 'project_pages', 'target_id' => $project->getID(), 'module' => 'core', 'user_id' => $user_id, 'access_level' => $access_level)); ?>
                            <?php include_component('configuration/permissionsblock', array('base_id' => $base_id . 'project_' . $project->getID() . '_issue_permissions', 'permissions_list' => TBGContext::getAvailablePermissions('issues'), 'mode' => 'general', 'target_id' => $project->getID(), 'module' => 'core', 'user_id' => $user_id, 'access_level' => $access_level)); ?>
                        </ul>
                    </li>
                <?php endforeach; ?>
            </ul>
