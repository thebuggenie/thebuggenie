...
<div class="team_dashboard">
    <div class="dashboard_team_info">
        ...
        <div class="project_header_right button-group">
            <button class="button button-silver dropper first last" id="team_<?php echo $team->getID(); ?>_more_actions"><?php echo __('Actions'); ?></button>
    ...
    <table class="team_dashboard_table">
        <tr>
            ...
            <td class="team_dashboard_users padded">
                <div class="header">
                    <?php echo __('Members of %team', array('%team' => __($team->getName()))); ?>&nbsp;(<?= $team->getNumberOfMembers(); ?>)
                </div>
