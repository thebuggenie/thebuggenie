            ...
            <tr>
                ...
                <td style="width: 400px; padding: 3px; font-size: 11px;">
                    <span onclick="$('debug_routes').toggle();" style="cursor: pointer;">
                        <?php echo image_tag('debug_route.png', array('style' => 'margin-right: 5px;')); ?>
                ...
                <td style="width: 150px; cursor: pointer; padding: 3px; font-size: 11px;" onclick="$('log_timing').toggle();" title="Click to toggle timing overview">
                    <?php echo image_tag('debug_time.png', array('style' => 'margin-right: 5px;')); ?>
                ...
                <td style="width: 100px; cursor: pointer; padding: 3px; font-size: 11px;" onclick="$('log_ajax').toggle();" title="Click to toggle ajax calls list">
                    <?php echo image_tag('debug_ajax.png', array('style' => 'margin-right: 5px;')); ?>
                ...
                <td onclick="$('scope_settings').toggle();" style="width: 80px; padding: 3px; cursor: pointer; font-size: 11px;" title="Generated hostname: <?php echo $tbg_summary['scope']['hostnames']; ?>">
                    <?php echo image_tag('debug_scope.png', array('style' => 'margin-right: 5px;')); ?>
                ...
                <td onclick="$('log_sql').toggle();" style="width: 100px; cursor: pointer; padding: 3px; font-size: 11px;<?php if (!\b2db\Core::isDebugMode()) echo ' color: #AAA;'; ?>" title="Database queries">
                    <?php echo image_tag('debug_database.png', array('style' => 'margin-right: 5px;')); ?>
    ...
    <div id="log_sql" style="display: none;">
        ...
        <div class="log">
            ...
            <?php foreach ($tbg_summary['db']['queries'] as $cc => $details): ?>
                <li>
                    <b><?php echo $cc+1; ?>
                                        <?php $file_details = explode(DS, $details['filename']); $filename = array_pop($file_details); ?>
                    <span class="faded_out dark small">[<?php echo ($details['time'] >= 1) ? round($details['time'], 2) . ' seconds' : round($details['time'] * 1000, 1) . 'ms'; ?>]</span> </b> from <?php echo join(DS, $file_details).DS.'<b>'.$filename.'</b>' ?>::<?php echo $details['function']; ?>() (line <?php echo $details['line']; ?>)</b>:<br>
