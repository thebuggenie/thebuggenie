<div id="item_option_<?php echo $todo_key; ?>_content">
          ...
          <a href="javascript:void(0);"
             onclick="TBG.Issues.markTodo(
                 ...
                 'comment_id' => $comment_id,
                     ...
                     '<?php echo base64_encode($todo) . '.' . $todo_index; ?>',
                     '<?php echo $todo_key; ?>');"
  ...
  <?php if (
    ($comment_id === 0
      && $issue->canEditDescription())
    || ($comment_id !== 0
      && $issue->getComments()[ $comment_id ]->canUserEditComment())
  ): ?>
    <?php echo javascript_link_tag(
      image_tag('icon_delete.png'), [
        'onclick' => "TBG.Main.Helpers.Dialog.show('"
          ...
          . "', '" . base64_encode($todo) . '.' . $todo_index
          . "'); }}, no: { click: TBG.Main.Helpers.Dialog.dismiss }});",
        'class' => 'todo-delete',
      ]
    ); ?>
    <?php //echo link_tag('#', image_tag('icon_move.png'), ['class' => 'todo_order']); ?>
  <?php endif; ?>
</div>