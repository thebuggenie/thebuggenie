<li>
    ...
    <?php echo fa_image_tag('star-o', array('id' => 'issue_favourite_faded_'.$issue->getId().'_'.$user->getID(), 'class' => 'unsubscribed', 'style' => 'display: none', 'onclick' => "TBG.Issues.toggleFavourite('".make_url('toggle_favourite_issue', array('issue_id' => $issue->getID(), 'user_id' => $user->getID()))."', '".$issue->getID().'_'.$user->getID()."');")); ?>
