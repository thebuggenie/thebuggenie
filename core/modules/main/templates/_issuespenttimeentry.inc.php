<ul class="simple_list">
    <li style="position: relative;">
        ...
        <?php echo sprintf('<span class="config_explanation" style="position: relative;">
                %s
            ...
            image_tag('icon_info.png', array('style' => 'margin: 0 5px 0 0; vertical-align: middle; cursor: pointer;')),
            ...
            __('Separate time with commas: "1 day, 3 hours" is fine, but "1 day 3 hours" will not be understood'),
            __('TBG (currently) only understands english: "2 hours" makes sense, "En time" not so much')
        ); ?>
