                ...
                <div id="comment_add_controls" class="backdrop_details_submit">
                    <span class="explanation">
                        <?php if ($target_type == \thebuggenie\core\entities\Comment::TYPE_ISSUE): ?>
                            <input type="checkbox" name="comment_save_changes" id="comment_save_changes" value="1"<?php if ($save_changes_checked): ?> checked<?php endif; ?>>&nbsp;<label for="comment_save_changes"><?= __('Save my changes with this comment'); ?></label>
                        <?php endif; ?>
