            ...
            <tbody>
                <?php foreach ($issue->getSpentTimes() as $spent_time): ?>
                    <tr id="issue_spenttime_<?php echo $spent_time->getID(); ?>">
                        ...
                        <td style="text-align: right;"><?php echo \thebuggenie\core\entities\Issue::getFormattedTime($spent_time->getSpentTime(true, true)); ?></td>
