<li class="hover_highlight<?php if ($issue->isClosed()): ?> closed<?php endif; ?> duplicatedissue" id="duplicated_issue_<?php echo $issue->getID(); ?>" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
