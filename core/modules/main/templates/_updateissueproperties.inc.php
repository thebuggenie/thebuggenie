                    ...
                    <?php if ($issue instanceof \thebuggenie\core\entities\Issue): ?>
                        <li id="transition_popup_stop_working_div_<?php echo $transition->getID(); ?>">
                            ...
                            <div class="time_logger_summary">
                                ...
                                <input type="radio" name="did" id="transition_popup_set_stop_working_<?php echo $transition->getID(); ?>" value="something" checked onchange="$('transition_popup_set_stop_working_specify_log_div_<?php echo $transition->getID(); ?>').hide();"><label for="transition_popup_set_stop_working_<?php echo $transition->getID(); ?>" class="simple"><?php echo __('Yes'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;<span class="faded_out"><?php echo __('Adds %minutes minute(s), %hours hour(s), %days day(s) and %weeks week(s)', array('%minutes' => $time_spent['minutes'], '%hours' => $time_spent['hours'], '%days' => $time_spent['days'], '%weeks' => $time_spent['weeks'])); ?></span><br>
