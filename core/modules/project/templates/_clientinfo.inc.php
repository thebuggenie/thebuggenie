<span class="project_client_header"><a href="<?php echo make_url('client_dashboard', array('client_id' => $client->getCode())); ?>"><?php echo $client->getName(); ?> [<?php echo $client->getCode(); ?>]</a></span><span class="project_client_viewusers"><a href="javascript:void(0);" onclick="TBG.Main.Helpers.Backdrop.show('<?php echo make_url('get_partial_for_backdrop', array('key' => 'client_users', 'client_id' => $client->getID())); ?>');"><?php echo __('View users'); ?></a></span><br />
<table>
    <tr>
