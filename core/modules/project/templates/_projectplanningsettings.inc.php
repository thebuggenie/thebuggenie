                    ...
                    <ul class="simple_list pcs_list">
                        <?php foreach ($all_columns as $fieldname => $fieldopts): ?>
                            <li class="pcs_<?= $fieldname; ?>">
                                ...
                                <label for="planning_column_<?= $fieldname; ?>"><?= fa_image_tag('check-square-o', ['class' => 'checked']) . fa_image_tag('square-o', ['class' => 'unchecked']) . __('Show %fieldlabel', array('%fieldlabel' => $fieldopts['label'])); ?>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
