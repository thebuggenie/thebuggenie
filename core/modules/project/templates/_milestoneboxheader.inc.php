    ...
    <div class="milestone_counts_container">
        <table>
            <tr>
                ...
                <td id="milestone_<?php echo $milestone->getID(); ?>_points_count" class="issue_estimates"><?php echo ($include_counts) ? $milestone->getPointsEstimated() .'/'. $milestone->getPointsSpent() : '-'; ?></td>
                <td id="milestone_<?php echo $milestone->getID(); ?>_hours_count" class="issue_estimates"><?php echo ($include_counts) ? $milestone->getHoursEstimated() .'/'. $milestone->getHoursSpent() : '-'; ?></td>
            </tr>
            <tr>
