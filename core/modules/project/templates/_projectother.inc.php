        ...
        <tr>
            ...
            <?php if ($access_level == \thebuggenie\core\framework\Settings::ACCESS_FULL): ?>
                <select name="frontpage_summary" id="frontpage_summary" <?php if ($access_level == \thebuggenie\core\framework\Settings::ACCESS_FULL): ?>onchange="$('checkboxes_issuetypes').hide();$('checkboxes_issuelist').hide();$('checkboxes_milestones').hide();if ($('checkboxes_'+this.getValue())) { $('checkboxes_'+this.getValue()).show(); }"<?php else: ?> disabled<?php endif; ?>>
                    ...
                    <option value="<?= \thebuggenie\core\entities\Project::SUMMARY_TYPE_MILESTONES; ?>"<?php if ($project->isMilestonesVisibleInFrontpageSummary()): ?> selected<?php endif; ?>><?php echo __('%on_frontpage_comma_show status per milestone', array('%on_frontpage_comma_show' => '')); ?></option>
                    <option value="<?= \thebuggenie\core\entities\Project::SUMMARY_TYPE_ISSUETYPES; ?>"<?php if ($project->isIssuetypesVisibleInFrontpageSummary()): ?> selected<?php endif; ?>><?php echo __('%on_frontpage_comma_show status per issue types', array('%on_frontpage_comma_show' => '')); ?></option>
                    <option value="<?= \thebuggenie\core\entities\Project::SUMMARY_TYPE_ISSUELIST; ?>"<?php if ($project->isIssuelistVisibleInFrontpageSummary()): ?> selected<?php endif; ?>><?php echo __('%on_frontpage_comma_show list of open issues', array('%on_frontpage_comma_show' => '')); ?></option>
                </select>
