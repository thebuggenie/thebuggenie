<table cellpadding=0 cellspacing=0 class="<?php echo $key; ?>_percentage statistics_percentage" style="margin: 5px 0 10px 0; width: 100%;">
    ...
    <?php foreach ($items as $item_id => $item): ?>
        <tr class="hover_highlight">
            ...
            <td><?php include_template('main/percentbar', array('percent' => 100 - $counts[$item_id]['percentage'], 'height' => 14)); ?></td>
        </tr>
    <?php endforeach; ?>
    <tr class="hover_highlight">
        ...
        <td class="faded_out"><?php include_template('main/percentbar', array('percent' => 100 - $counts[0]['percentage'], 'height' => 14)); ?></td>
    </tr>
</table>
