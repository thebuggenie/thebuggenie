...
?>
<div id="milestone_<?php echo $milestone->getID(); ?>" class="milestone_box <?php if (!$milestone->isVisibleRoadmap()) echo ' unavailable'; ?> <?php if ($milestone->isReached()) echo 'closed'; ?>" data-milestone-id="<?php echo $milestone->getID(); ?>" <?php if (isset($board)): ?> data-issues-url="<?php echo make_url('project_planning_milestone_issues', array('project_key' => $milestone->getProject()->getKey(), 'milestone_id' => $milestone->getID(), 'board_id' => $board->getID())); ?>" data-assign-issue-url="<?php echo make_url('project_planning_assign_milestone', array('project_key' => $milestone->getProject()->getKey(), 'milestone_id' => $milestone->getID())); ?>" <?php endif; ?>>
