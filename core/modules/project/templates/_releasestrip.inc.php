<?php foreach ($board->getReleases() as $release): ?>
    <li class="release" id="release_<?php echo $release->getId(); ?>" data-release-id="<?php echo $release->getID(); ?>" data-assign-issue-url="<?php echo make_url('project_planning_assign_release', array('project_key' => $board->getProject()->getKey(), 'release_id' => $release->getID())); ?>">
