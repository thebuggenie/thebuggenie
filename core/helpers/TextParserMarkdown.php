<?php
    ...
    class TextParserMarkdown extends MarkdownExtra implements ContentParser
    {
        ...
        protected function _parse_mention($matches)
        {
            ...
            {
                $output = framework\Action::returnComponentHTML('main/userdropdown_inline', array('user' => $matches[1], 'displayname' => $matches[0], 'in_email' => (bool) $this->options['in_email'] ?: false));
