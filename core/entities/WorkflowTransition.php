<?php
    ...
    class WorkflowTransition extends IdentifiableScoped
    {
        ...
        public static function loadFixtures(\thebuggenie\core\entities\Scope $scope, \thebuggenie\core\entities\Workflow $workflow, $steps)
        {
            ...
            $transitions['confirmissue'] = array('name' => 'Confirm issue', 'description' => 'Confirm that the issue is valid', 'outgoing_step' => 'confirmed', 'template' => null, 'actions' => array(WorkflowTransitionAction::ACTION_SET_PERCENT => 10, WorkflowTransitionAction::ACTION_SET_PRIORITY));
