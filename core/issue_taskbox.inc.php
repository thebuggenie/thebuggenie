...
if ($theIssue->canEditTexts())
{
	...
	<?php echo tbg_newTextArea('task_new_content', '80px', '100%', $theTask->getContent()) ?>
...
<td class="issuedetailscontentscenter" style="font-size: 10px; width: 80px;" id="task_<?php echo $theTask->getID(); ?>_lastupdated"><?php echo tbg_formatTime($theTask->getUpdated(), 4); ?></td>
...
<?php echo tbg_BBDecode($theTask->getContent()); ?>
