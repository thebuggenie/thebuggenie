<?php
	 ...
	 * @return unknown_type
	 */
	function tbg_AJAXuserteamselector($user_title, $team_title, $setuser_url, $setteam_url, $setuser_update_div, $setuser_update_url, $setteam_update_div, $setteam_update_url, $container_span, $group_title = '', $setgroup_url = '', $setgroup_update_div = '', $setgroup_update_url = '', $noteams = false)
	{
	}
	 ...
	 * @return string
	 */
	function tbg_printColorOptions($color, $data)
	{
	 ...
	 * @return string
	 */
	function tbg_helpBrowserHelper($topic, $linktext)
	{
	 ...
	 * 
	 * @see tbg_teamDropdown
	 * @see tbg_userDropdown
	 * 
	 * @return string
	 */
	function tbg_customerDropdown($cid, $dontclose = 0)
	{
		return tbg_teamDropdown($cid, $dontclose, true);
	}
	 ...
	 * @param bool $dontclose
	 * 
	 * @see tbg_customerDropdown
	 * @see tbg_userDropdown
	 * 
	 * @return string
	 */
	function tbg_teamDropdown($tid, $dontclose = 0, $is_customer = false)
	{
	 ...
	 * @return null
	 */
	function tbg_printMilestones($project_id, $onlyVisible = true)
	{
		...
		foreach($milestones as $aMilestone)
		{
			...
			if($aMilestone->isScheduled()) {
				echo __('Scheduled: %date%', array('%date%' => tbg_formatTime($aMilestone->getScheduledDate(), 5)));
			} else {
			...
			<div style="padding: 2px;"><?php tbg_printPercentBar($aMilestone->getPercentComplete(), 10); ?></div>
	 ...
	 * @return string
	 */
	function tbg_printPercentBar($percent, $size = 16)
	{
	 ...
	 * 
	 * @see tbg_failureStrip
	 * 
	 * @return string
	 */
	function tbg_successStrip($title, $content = '', $id = '', $start_hidden = false, $multiline = true)
	{
		$retval = '';
	 ...
	 * @param bool $multiline[optional] whether or not the box is multiline
	 * 
	 * @see tbg_successStrip
	 * 
	 * @return string
	 */
	function tbg_failureStrip($title, $content = '', $id = '', $start_hidden = false)
	{
		$retval = '';
	 ...
	 * @return null
	 */
	function tbg_printmodeStrip($normalmode_link)
	{
		?>
