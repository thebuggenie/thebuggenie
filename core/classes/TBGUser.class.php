<?php
    ...
    use thebuggenie\core\entities\IdentifiableEventContainerClass;
     ...
     */
    class TBGUser extends IdentifiableEventContainerClass
    {
        ...
        protected function _preSave($is_new)
        {
            ...
            if (!TBGContext::isInstallmode() && !TBGContext::isUpgrademode())
            {
