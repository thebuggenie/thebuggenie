<?php
    ...
    class TBGActionComponent extends TBGParameterholder
    {
        ...
        protected static function getFinalTemplateName($template, $module_file = null)
        {
            ...
            {
                $template_basepath = (TBGContext::isInternalModule($module_file['module'])) ? THEBUGGENIE_INTERNAL_MODULES_PATH : THEBUGGENIE_MODULES_PATH;
        ...
        {
            $module_file = self::getModuleAndTemplate($template);
            $actionClassName = (TBGContext::isInternalModule($module_file['module'])) ? "\\thebuggenie\\core\\modules\\".$module_file['module']."\\Components" : "\\thebuggenie\\modules\\".$module_file['module']."\\Components";
