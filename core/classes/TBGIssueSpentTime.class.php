<?php
     ...
     * @subpackage main
     *
     * @Table(name="TBGIssueSpentTimesTable")
     */
    class TBGIssueSpentTime extends TBGIdentifiableScopedClass
    {
        ...
        {
            return ($this->getActivityType() instanceof TBGActivityType) ? $this->getActivityType()->getID() : 0;
        }

        /**
         * @return TBGIssue the related issue
         */
