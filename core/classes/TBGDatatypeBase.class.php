<?php
	...
	abstract class TBGDatatypeBase extends TBGIdentifiableClass
	{
		...
		{
			$builtin_types = array('description', 'reproduction_steps', 'status', 'category', 'resolution', 'priority', 'reproducability', 'percent_complete', 'severity', 'owner', 'assignee', 'editions', 'builds', 'components', 'estimated_time', 'elapsed_time', 'milestone', 'user_pain', 'votes');
