...
/*				width:700px;*/
	...
	<body>
		<div class="medium_transparent rounded_box shadowed popup_message failure" onclick="TBG.Main.clearPopupMessages();" style="display: none;" id="thebuggenie_failuremessage">
		...
		<div class="medium_transparent rounded_box shadowed popup_message success" onclick="TBG.Main.clearPopupMessages();" style="display: none;" id="thebuggenie_successmessage">
			<div style="padding: 10px 0 10px 0;">
				<div class="dismiss_me"><?php echo __('Click this message to dismiss it'); ?></div>
		...
		<div id="fullpage_backdrop" style="display: none; background-color: transparent; width: 100%; height: 100%; position: fixed; top: 0; left: 0; margin: 0; padding: 0; text-align: center;">
			...
			<div style="background-color: #000; width: 100%; height: 100%; position: absolute; top: 0; left: 0; margin: 0; padding: 0; z-index: 100000;" class="semi_transparent" <?php if (TBGContext::getRouting()->getCurrentRouteAction() != 'login'): ?>onclick="TBG.Main.resetFadedBackdrop();"<?php endif; ?>> </div>
		</div>
								...
								<div class="tab_menu header_menu<?php if (TBGContext::isProjectContext()): ?> project_context<?php endif; ?>">
									...
									<div class="rounded_box blue tab_menu_container" id="header_userinfo">
											...
											<tr>
												...
												<td id="header_username" valign="middle">
													<?php if ($tbg_user->isGuest()): ?>
														<a href="javascript:void(0);" onclick="TBG.Main.showFadedBackdrop('<?php echo make_url('get_partial_for_backdrop', array('key' => 'login')); ?>')"><?php echo __('You are not logged in'); ?></a>
													<?php else: ?>
										...
										<div class="rounded_box blue tab_menu_dropdown user_menu_dropdown shadowed">
											<?php if ($tbg_user->isGuest()): ?>
												<a href="javascript:void(0);" onclick="TBG.Main.showFadedBackdrop('<?php echo make_url('get_partial_for_backdrop', array('key' => 'login')); ?>')"><?php echo image_tag('icon_login.png').__('Login'); ?></a>
												<?php if (TBGSettings::isRegistrationAllowed()): ?>
													<a href="javascript:void(0);" onclick="TBG.Main.showFadedBackdrop('<?php echo make_url('get_partial_for_backdrop', array('key' => 'login', 'section' => 'register')); ?>');"><?php echo image_tag('icon_register.png').__('Register'); ?></a>
												<?php endif; ?>
											<?php else: ?>
