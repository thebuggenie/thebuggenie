<?php
    if (TBGContext::isProjectContext())
        $boards = \thebuggenie\core\entities\AgileBoard::getB2DBTable()->getAvailableProjectBoards($tbg_user->getID(), TBGContext::getCurrentProject()->getID());
?>
            ...
            <?php elseif (TBGContext::isProjectContext()): ?>
                ...
                <li<?php if (in_array($tbg_response->getPage(), array('project_dashboard', 'project_scrum_sprint_details', 'project_timeline', 'project_team', 'project_roadmap', 'project_statistics', 'vcs_commitspage'))): ?> class="selected"<?php endif; ?>>
                    <div class="menuitem_container">
                        <?php echo link_tag(make_url($page, array('project_key' => TBGContext::getCurrentProject()->getKey())), image_tag('icon_dashboard_small.png') . tbg_get_pagename($tbg_response->getPage())); ?>
                ...
                <?php if ($tbg_user->hasProjectPageAccess('project_planning', TBGContext::getCurrentProject())): ?>
                    <li<?php if (in_array($tbg_response->getPage(), array('project_planning'))): ?> class="selected"<?php endif; ?>>
                        ...
                        <div class="tab_menu_dropdown">
                            <?php echo link_tag(make_url('project_planning', array('project_key' => TBGContext::getCurrentProject()->getKey())), __('Manage boards'), ((in_array($tbg_response->getPage(), array('project_planning'))) ? array('class' => 'selected') : array())); ?>
